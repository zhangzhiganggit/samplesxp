							...
							<div class="widget-box widget-color-normal3" style="opacity: 1;">
								<div class="widget-header">
									<h5 class="widget-title bigger lighter">
										<i class="ace-icon fa fa-table">代理商即刷即到批量开通</i>
									</h5>
								...
								<div class="widget-body">
									<div class="widget-main no-padding ">
										<div class="widget-main ">
											<form class="form-inline form-horizontal"
												...
												<div class="form-group form-group-sm width-300px ">
													...
													<div class="col-sm-8  no-padding">
														<select data-placeholder="请选择" id="status" disabled="disabled" name="goodsId"
											...
											<%-- 	<div class="form-group form-group-sm width-300px ">
													 <a class="btn btn-info btn-sm"  href="<%=request.getContextPath()%>/MobAgentTimelyAccount/downloadExcel?templetName=agentOpenTimelyAccount.xlsx">
