							...
							<div class="widget-box widget-color-normal3" style="opacity: 1;">
								<div class="widget-header">
									<h5 class="widget-title bigger lighter">
										<i class="ace-icon fa fa-table">代理商即刷即到暂停拓展/恢复</i>
									</h5>
										...
										<div class="widget-main ">
											<form class="form-inline form-horizontal"
												...
												<div class="form-group form-group-sm width-300px ">
													<label
														class="col-sm-4 control-label widget-color-normal5 width-100px no-padding-left">目标业务状态:</label>
													<div class="col-sm-8  no-padding">
														<select data-placeholder="请选择" id="status" name="goodsId"
															class="chosen-select form-control width-200px">
															<option value="0" selected="selected">暂停拓展</option>
															<option value="1">恢复</option>
														</select>
													</div>
												</div>
												<div class="form-group form-group-sm width-300px ">
													 <a class="btn btn-info btn-sm"  href="<%=request.getContextPath()%>/MobAgentTimelyAccount/downloadExcel?templetName=agentTimelyAccountPuaseRecover.xlsx">
