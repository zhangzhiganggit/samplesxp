...
<body class="no-skin ">
   ...
   <%--  <%@include file="../layout/header.jsp"%> --%>
                                ...
                                <div class="widget-body">
                                    <div class="widget-main no-padding ">
                                        <div class="widget-main ">
                                            ...
                                            <form class="form-inline form-horizontal" action="<%=request.getContextPath()%>/mercValiRepeat/exportList.do" id="searchForm" method="post">
                                                ...
                                                <div class=" col-xs-12">
                                                    <div class="form-group form-group-sm width-300px">
                                                        ...
                                                        <div class="col-sm-8  no-padding"  >
                                                            <input type="text" id="orderNo"  name="orderNo" value="${mercIncome.orderNo }" class="form-control input-small width-200px" data-placement="bottom" title=""   data-rel="tooltip" data-original-title="Hello Tooltip!">
                                                        </div>
                                                    </div>
                                                    <div class="form-group form-group-sm width-300px">
                                                        ...
                                                        <div class="col-sm-8  no-padding"  >
                                                            <input type="text" id="orgNm" name="orgNm" value="${mercIncome.orgNm }" class="form-control input-small width-200px " data-placement="bottom" title=""   data-rel="tooltip" data-original-title="Hello Tooltip!">
                                                        </div>
                                                    </div>
                                                    <div class="form-group form-group-sm width-300px ">
                                                        ...
                                                        <div class="col-sm-8   no-padding">
                                                            ...
                                                            <div class="input-daterange input-group width-200px">
                                                                <input type="text" id="startDate" name="startDate" value="${mercIncome.startDate }" class="input-small form-control">
                                                                                <span class="input-group-addon">
                                                                                    <i class="fa fa-exchange"></i>
                                                                                </span>

                                                                <input type="text" id="endDate" name="endDate" value="${mercIncome.endDate }" class="input-small form-control">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group form-group-sm width-300px ">
                                                        ...
                                                        <div class="col-sm-8  no-padding"  >
                                                           <select id="exceptTyp" name="exceptTyp" data-placeholder="请选择"  class="chosen-select form-control width-200px">
                                                               ...
                                                               <option value="0" <c:if test="${mercIncome.exceptTyp=='0' }">selected</c:if>>结算人卡号一</option>
											    				<option value="1" <c:if test="${mercIncome.exceptTyp=='1' }">selected</c:if>>结算人户名一</option>
											    				<option value="2" <c:if test="${mercIncome.exceptTyp=='2' }">selected</c:if>>结算人证件号一</option>
											    				<option value="3" <c:if test="${mercIncome.exceptTyp=='3' }">selected</c:if>>结算人卡号二</option>
											    				<option value="4" <c:if test="${mercIncome.exceptTyp=='4' }">selected</c:if>>结算人户名二</option>
											    				<option value="5" <c:if test="${mercIncome.exceptTyp=='5' }">selected</c:if>>结算人证件号二</option>
											    				<option value="6" <c:if test="${mercIncome.exceptTyp=='6' }">selected</c:if>>注册名称</option>
											    				<option value="7" <c:if test="${mercIncome.exceptTyp=='7' }">selected</c:if>>注册登记号</option>
											    				<option value="8" <c:if test="${mercIncome.exceptTyp=='8' }">selected</c:if>>法人名称</option>
											    				<option value="9" <c:if test="${mercIncome.exceptTyp=='9' }">selected</c:if>>法人证件号</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="form-group form-group-sm width-300px">
                                                        ...
                                                        <div class="col-sm-8  no-padding"  >
                                                            <input type="text" name="num" value="${mercIncome.num }" id="num" class="form-control input-small width-200px" data-placement="bottom" title=""   data-rel="tooltip" data-original-title="Hello Tooltip!">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group form-group-sm width-300px ">
                                                        ...
                                                        <div class="col-sm-8  no-padding"  >
                                                          <select id="isExcept" name="isExcept" class="chosen-select form-control width-200px">
										    					...
										    					<option value="1" <c:if test="${mercIncome.isExcept=='1' }">selected</c:if>>是</option>
										    					<option value="0" <c:if test="${mercIncome.isExcept=='0' }">selected</c:if>>否</option>
										    					<option value="2" <c:if test="${mercIncome.isExcept=='2' }">selected</c:if>>全量</option>
														</select>
                                                        </div>
                                                    </div>
                                                    <div class="form-group form-group-sm width-300px">
                                                        ...
                                                        <div class="col-sm-6  no-padding"  >
									    					...
									    					<option value="" selected>全部</option>
									    					<option value="SXF01" <c:if test="${mercIncome.orderTyp=='SXF01' }">selected</c:if>>进件</option>
									    					<option value="SXF02" <c:if test="${mercIncome.orderTyp=='SXF02' }">selected</c:if>>修改</option>
														</select>
                                                        </div>
                                                    </div>
                                        ...
                                        <table class="table table-striped table-bordered table-hover dataTable no-footer DTTT_selectable">
                                           ...
                                           <c:forEach items="${resultList}" var="de"  varStatus="status">
													<tr>
														...
														<td style="text-align: center;">${de.idCardNum2 }</td>
    ...
    function uploadExcel(){
		$("#searchForm").attr("action","<%=request.getContextPath()%>/mercValiRepeat/uploadExcel.do");
		document.getElementById("searchForm").submit();
		$("#searchForm").attr("action","<%=request.getContextPath()%>/mercValiRepeat/exportList.do");
	}
    
      function mecIfdetailShow(id){
    	  $.fancybox.open({
				href : '<%=request.getContextPath() %>/mercValiRepeat/exportDetail.do?uuid='+id,
				type: 'iframe',
	        padding: 5,
	        scrolling: 'no',
	        fitToView: true,
