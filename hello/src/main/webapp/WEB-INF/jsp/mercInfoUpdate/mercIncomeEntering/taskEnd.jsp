...
<head>
    ...
    <script type="text/javascript">
    	function taskEnd(){
    		...
    		$.ajax({
    			url:"/mercIncomeEntering/taskEnd.do",
    			type:"post",
					...
					<div class="row">
						<div class=" widget-container-col ui-sortable  ">
							<div class="widget-box widget-color-normal3" style="opacity: 1;" >
                                ...
                                <form class="form-inline form-horizontal" action="<%=request.getContextPath() %>/mercIncomeEntering/taskEnd.do" id="searchForm" method="post"  enctype="multipart/form-data">
												...
												<div class=" col-xs-12">
													<div class="form-group form-group-sm width-300px" style="width: 810px;">
														<label for="form-field-6"
															class="col-sm-4 control-label widget-color-normal5 width-100px no-padding-left">结束原因:</label>
														<div class="col-sm-8  no-padding">
															<input type="text" name="stopReason"
																class="form-control input-small width-300px"
												...
												<div class=" col-xs-12">
													<div class="form-group form-group-sm width-300px">
														<input type="text" name="strMsg"
															...
															value="${strMsg }" onfocus="this.blur();"
															data-rel="tooltip" data-original-title="Hello Tooltip!">
													</div>
												</div>
