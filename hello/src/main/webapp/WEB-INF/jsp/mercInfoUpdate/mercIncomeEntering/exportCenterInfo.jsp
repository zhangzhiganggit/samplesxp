                                ...
                                <div class="widget-body">
                                    <div class="widget-main no-padding ">
                                        <div class="widget-main ">
                                            <form id="searchForm" class="form-inline form-horizontal" method="post"  action="<%=base%>mercIncomeEntering/exportCenterInfo.do">
                                                        ...
                                                        <div class="col-sm-8  no-padding">
                                                        	<div class=" input-group width-100" style="height: 30px;line-height: 30px;">
	                                                            ...
	                                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="orderType" id="update" onchange="dateChange()" value="1" ><label for="update">商户信息变更流程</label>
	                                                             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="orderType" id="tranform" onchange="dateChange()" value="3" ><label for="tranform">小微转普通</label>
	                                                        </div>
                                                        </div>
                                                    </div>
...
<!-- inline scripts related to this page -->
    ...
    function checkbutton(){
    	...
    	}else if(!document.getElementById("income").checked  && !document.getElementById("update").checked  && !document.getElementById("tranform").checked){
			alert("至少选择一种流程")
		}else{
			$("#hiddenSubmit").click();
