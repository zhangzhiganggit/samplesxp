...
<body class="no-skin ">
                    ...
                    <div class="row" >
                        <div class=" widget-container-col ui-sortable  "  >
                            <div class="widget-box widget-color-normal2" style="opacity: 1;">
                        		...
                        		<input type="hidden" name="orderNo" id="orderNo" value="${taskEntrustInfo.orderNo}"/>
                        		...
                        		<div class=" col-sm-12">
                        		  <div class="form-group form-group-sm width-100">
                                      <label  class="col-sm-12 control-label widget-color-normal5 width-100px no-padding-left"  ><font color="red">*</font>委托原因:</label>
                                ...
                                <div class="form-group form-group-sm width-300px">
                                    <label for="form-field-6" class="col-sm-4 control-label widget-color-normal5 width-100px no-padding-left"  ><font color="red">*</font>接收人:</label>
                                    <div class="col-sm-8  no-padding"  >
    ...
    <script type="text/javascript">
        ...
        function chooseOthers() {
        	...
        	var url="<%=request.getContextPath()%>/taskEntrust/chooseNextAdmin2.do";
    		if(confirm("确认要委托？")){
    	    	$.ajax({
    	    		type:'post',
    	    		url:url,
