							...
							<div class="widget-box widget-color-normal3">
								<div class="widget-header">
									<h5 class="widget-title bigger lighter">
										<i class="ace-icon fa fa-table"></i> 商户基本信息展示
									</h5>
								</div>
												...
												<div class=" col-xs-12 no-padding">
													<div class="tabbable">
														<ul id="myTab4"
															...
															<li class="active"><a href="#home4" data-toggle="tab">基本信息</a></li>
														...
														<div class="tab-content ">
															<div class="tab-pane active no-padding" id="home4">
																<div class="col-sm-12">
																	...
																	<div class="form-group form-group-sm width-300px">
																		...
																		<div class="col-sm-8  no-padding">
																			<label
																				...
																				data-content="" data-placement="bottom"
																				data-trigger="hover" data-rel="popover">
																				<c:if test="${minf.mobileOperTyp=='LS0001'}">零售</c:if>
																				<c:if test="${minf.mobileOperTyp=='TG0001'}">团购</c:if>
																				</label>
																		</div>
																	</div>
																	<div class="form-group form-group-sm width-300px">
																		<label
																			class="col-sm-4 control-label widget-color-normal5 width-100px no-padding-left">刷卡费率:</label>
																		<div class="col-sm-8  no-padding">
																			<label
																				class="form-control input-small width-200px   view-control  "
																				data-content="" data-placement="bottom"
																	...
																	<div class="form-group form-group-sm width-300px">
																		<label
																			class="col-sm-4 control-label widget-color-normal5 width-100px no-padding-left">扫码费率:</label>
																		<div class="col-sm-8  no-padding">
																			<label
																				class="form-control input-small width-200px   view-control  "
																				data-content="" data-placement="bottom"
																				data-trigger="hover" data-rel="popover">
																				<c:choose>
																				<c:when test="${minf.qrcodeRat ==null }"></c:when>
																				<c:otherwise>${minf.qrcodeRat}%</c:otherwise>
																				</c:choose></label>
																		</div>
																	</div>
																	<div class="form-group form-group-sm width-300px">
																	...
																	<div class="form-group form-group-sm width-300px">
																		...
																		<div class="col-sm-8  no-padding">
																			<label
																				class="form-control input-small width-200px   view-control  "
																				data-content="${minf.busAddr}"data-placement="bottom"
																				data-trigger="hover" data-rel="popover">${minf.busAddr }</label>
																		</div>
																	</div>
																	<div class="form-group form-group-sm width-300px">
																		<label
																	...
																	<div class="form-group form-group-sm width-300px">
																		...
																		<div class="col-sm-8  no-padding">
																			<label
																				...
																				data-content="" data-placement="bottom"
																				data-trigger="hover" data-rel="popover">
																				<c:if test="${minf.jsjdSts== null || minf.jsjdSts != '1'}">关闭</c:if>
															...
															<div class="tab-pane no-padding" id="home6">
																<div class="col-sm-12">
																<c:forEach items="${msi}" var="stmInfo" varStatus="status">
																	<div class="form-group form-group-sm width-300px">
																		<label
																		...
																		<div class="col-sm-8  no-padding">
																			<label
																				class="form-control input-small width-200px   view-control  "
																				data-content="${stmInfo.stmLbankNo1 }" data-placement="bottom"
																				data-trigger="hover" data-rel="popover">${stmInfo.stmLbankNo1 }</label>
																		</div>
																	</div>
																	<div class="form-group form-group-sm width-300px">
																		<label
																		...
																		<div class="col-sm-8  no-padding">
																			<label
																				class="form-control input-small width-200px   view-control  "
																				data-content="${stmInfo.stmActNm1 }" data-placement="bottom"
																				data-trigger="hover" data-rel="popover">${stmInfo.stmActNm1 }</label>
																		</div>
																	</div>
																	<div class="form-group form-group-sm width-300px">
																		<label
																		...
																		<div class="col-sm-8  no-padding">
																			<label
																				class="form-control input-small width-200px   view-control  "
																				data-content="${stmInfo.stmAct1 }" data-placement="bottom"
																				data-trigger="hover" data-rel="popover">${stmInfo.stmAct1 }</label>
																		</div>
																	</div>
																	<div class="form-group form-group-sm width-300px">
																		<label
																		...
																		<div class="col-sm-8  no-padding">
																			<label
																				class="form-control input-small width-200px   view-control  "
																				data-content="${stmInfo.stmBankProvince1 }" data-placement="bottom"
																				data-trigger="hover" data-rel="popover">${stmInfo.stmBankProvince1 }</label>
																		</div>
																	</div>
																	<div class="form-group form-group-sm width-300px">
																		<label
																		...
																		<div class="col-sm-8  no-padding">
																			<label
																				class="form-control input-small width-200px   view-control  "
																				data-content="${stmInfo.stmBankCity1 }" data-placement="bottom"
																				data-trigger="hover" data-rel="popover">${stmInfo.stmBankCity1 }</label>
																		</div>
																	</div>
																	<div class="form-group form-group-sm width-300px">
																		<label
																		...
																		<div class="col-sm-8  no-padding">
																			<label
																				class="form-control input-small width-200px   view-control  "
																				data-content="${stmInfo.stmBankDetails1 }" data-placement="bottom"
																				data-trigger="hover" data-rel="popover">${stmInfo.stmBankDetails1 }</label>
																		</div>
																	</div>
																	<br/><br/>
																</c:forEach>
