									...
									<div class="widget-main no-padding ">
										<div class="widget-main ">
											...
											<form class="form-inline form-horizontal"
												action="<%=request.getContextPath()%>/mecIfDatum/list.do"
												...
												<div class=" col-xs-12">
													...
													<div class="form-group form-group-sm width-300px">
														<label for="form-field-6"
															class="col-sm-4 control-label widget-color-normal5 width-100px no-padding-left">工单号:</label>
									...
									<div class="widget-main no-padding ">
										<table
											...
											<thead class="thin-border-bottom">
												<tr>
													<th style="text-align: center; width: 9%">流程实例ID</th>
													<th style="text-align: center; width: 10%">流程名称</th>
													<th style="text-align: center; width: 18%">工单号</th>
													<th style="text-align: center; width: 15%">注册名称</th>
													<th style="text-align: center; width: 10%">生成商编</th>
													<th style="text-align: center; width: 8%">发起人</th>
													<th style="text-align: center; width: 11%">发起时间</th>
													<th style="text-align: center; width: 11%">结束时间</th>
													...
													<tr>
														...
														<td style="text-align: center;">
															<div class="   action-buttons">
																<a href="#"
																	onclick="mecIfDatumSetdetailShow('${taskInfo.businessKey}','${taskInfo.procInstId}','${taskInfo.endTime }')"
