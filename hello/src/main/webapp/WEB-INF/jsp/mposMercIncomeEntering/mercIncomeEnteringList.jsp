                                ...
                                <div class="widget-body">
                                    <div class="widget-main no-padding ">
                                        <div class="widget-main ">
                                            <form class="form-inline form-horizontal" action="mercIncomeEnteringList?entry=1" id="searchForm" method="post">
                                            	...
                                            	<c:forEach var="mercIncomeEntering" items="${mercIncomeEnteringList}">
                                            		<tr>
                                            			<td class="" style="text-align: center;">
                                                            ...
                                                            <c:if test="${mercIncomeEntering.currentStatus != '办理中'  && mercIncomeEnteringThis.currentStatus != '风控办理中' }"> disabled</c:if>
                                                            >
		                                                ...
		                                                <td align="center">${mercIncomeEntering.currentStatus }</td>
		                                                <td align="center">
	                                                        <div class="action-buttons">
																...
																<c:if test="${(mercIncomeEntering.currentStatus=='待审核' || mercIncomeEntering.currentStatus=='待风控审核') && mercIncomeEnteringThis.currentStatus==\"'1','4','6'\"}">
																...
																<c:if test="${mercIncomeEntering.currentStatus=='办理中' || mercIncomeEntering.currentStatus=='风控办理中' && mercIncomeEnteringThis.currentStatus==\"'2','3','8'\"}">
																...
																<c:if test="${mercIncomeEntering.taskDefKey=='centerCheck' && loginUserPermission.SMSA_FORBID_002 != null}">
