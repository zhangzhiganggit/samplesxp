						...
						<div class=" widget-container-col ui-sortable">
							<div class="widget-box widget-color-normal3">
								...
								<div class="widget-main " style="padding-left: 20px" >
									...
									action="/bond/manage/batchImport" 
									method="post" enctype ="multipart/form-data">
										<h3 class="header smaller lighter green">选择Excel导入，最多允许导入3000条数据！</h3>
										<div class="form-group form-group-sm width-300px">
											...
											<div style="float: left;">
												...
												<font color="red"  style="float: left; ">上传的excel文件付款时间格式必须遵循<br/>"YYYY-MM-DD"格式否则将无法导入数据</font>
											</div>
										</div>
