...
<body class="no-skin ">
                                ...
                                <div class="widget-body">
                                    <div class="widget-main no-padding ">
                                        <div class="widget-main ">
                                            <form class="form-inline form-horizontal" action="/sspForbidAuditRule/handleSspForbidAuditRule" id="batchForbidAuditForm" method="post">
                                                <div class=" col-xs-12">
                                                    <div class="form-group form-group-sm width-300px">
                                                        ...
                                                        <div class="col-sm-8  no-padding"  >
                                                            <input type="text" name="orgNo" id="orgNo" value="${orgNo}" onchange="getOrgNmByOrgNo()" class="form-control input-small width-200px" data-placement="bottom" data-rel="tooltip">
                                                        </div>
                                                    </div>
                                                    <div class="form-group form-group-sm width-300px">
    ...
    <script type="text/javascript">
					...
					function batchForbidAudit() {
						...
						var forbidAuditReason = $("#forbidAuditReason").val()
								.replace(/(^\s*)|(\s*$)/g, '');
						...
						if ($("#operatedTyp").val() == '2') {
							...
							if ($("#oldOrderTyp").val() == '0'
									&& $("#orderTyp").val() == '1') {
								noBatchCount = noBatchCount2;
							} else if ($("#oldOrderTyp").val() == '0'
									&& $("#orderTyp").val() == '2') {
								noBatchCount = noBatchCount1;
							} else if ($("#oldOrderTyp").val() == '1'
									&& $("#orderTyp").val() == '2') {
								noBatchCount = noBatchCount1;
							} else if ($("#oldOrderTyp").val() == '2'
									&& $("#orderTyp").val() == '1') {
								noBatchCount = noBatchCount1;
							}
						}
						...
						if ($("#operatedTyp").val() != '0' && noBatchCount != 0) {
							var r = confirm("数据中含有" + noBatchCount
									+ "条单条禁审记录,是否要对其进行操作？");
							if (r) {
								$("#isAll").val("1");
							} else {
						...
						$.ajax({
							cache : true,
							type : "POST",
							url : '/sspForbidAuditRule/handleSspForbidAuditRule.do',
