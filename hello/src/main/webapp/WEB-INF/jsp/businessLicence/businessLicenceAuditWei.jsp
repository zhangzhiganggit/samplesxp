										...
										<div class="widget-main ">
											<form id="submitForm" class="form-inline form-horizontal"
												...
												<div class="col-sm-12">
													...
													<h3 class="header smaller lighter green">营业执照信息</h3>
													...
													<table style="height: 80px">
														<tr style="width: 100%">
															...
															<td><div class="form-group form-group-sm ">
																	...
																	<div class="col-sm-8  no-padding ">
																		<input type="text" name="mcc" id="mcc" onblur="checkMcc()"
	...
	function Verification(){
		...
		function checkCommit(checkResult) {
			if(checkResult == '01'){
				...
				if ($("#credentialNumber").val() == "") {
					alert("法人证件号码不能为空");
					return;
				}
				var idCard = $("#credentialNumber").val();
			...
			if (checkResult == '02') {//审核驳回
				...
				if (rebutReason <= 0 && (other=="" || other==null || other==undefined )) {
