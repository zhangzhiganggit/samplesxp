...
<head>
    ...
    function operationFun(obj,obj1){
    	var url="";
    	if(obj=='insert'){
    		url = "<%=base%>restrict/restrictAdd.do";
    	}else if(obj=='update'){
    		url = "<%=base%>restrict/restrictAdd.do?uuid="+obj1;
    	}else if(obj=='log'){
    		url = "<%=base%>restrict/seeOperLog?restrictUuid="+obj1;
    		w=1100*1;
    	}
    	$.fancybox.open({
			href : url,
                                ...
                                <div class="widget-body">
                                    <div class="widget-main no-padding ">
                                        <div class="widget-main ">
                                            ...
                                            <form class="form-inline form-horizontal" action="<%=base%>restrict/restrictTimesList" id="searchForm" method="post">
													...
													<div class="form-group form-group-sm width-300px ">
                                                        ...
                                                        <div class="col-sm-8   no-padding">
                                                            ...
                                                            <div class="input-daterange input-group width-200px">
                                                                <input type="text" name="startDate" value="${restrict.startDate }" class="input-small form-control">
                                                                                <span class="input-group-addon">
                                                                                    <i class="fa fa-exchange"></i>
                                                                                </span>

                                                                <input type="text" name="endDate" value="${restrict.endDate }" class="input-small form-control">
                                                            </div>
                                                        </div>
                                                    </div>
												</div>
                                ...
                                <div class="widget-body">
                                    <div class="widget-main no-padding ">
                                        <table style="word-break:break-all; word-wrap:break-all; " class="table table-striped table-bordered table-hover dataTable no-footer DTTT_selectable">
                                            ...
                                            <tbody>
                                            <c:forEach items="${tBizRestrictTimesPos }" var="po">
                                            <tr>

                                                <td align="left"> ${po.orgNm } </td>
                                                <td align="center">${po.mercTypStr }</td>
                                                <td align="right">${po.actNoNum}</td>
                                                <td align="right">${po.actNmNum}</td>
                                                <td align="right">${po.idCardNum}</td>
                                                <td align="right">${po.regNoNum}</td>
                                                <td align="right">${po.regNmNum}</td>
                                                <td align="center">${po.operNo}</td>
                                                <td align="center">${po.operTimes}</td>
                                                <td align="center">
                                                	 <div class="   action-buttons">
                                                        <a class="blue" href="javascript:;" onclick="operationFun('update','${po.uuid }')">修改</a>
                                                        <%-- <a class="blue" href="javascript:;" onclick="deleteDept('${po.uuid }')">删除</a> --%>
