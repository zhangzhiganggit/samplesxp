                        ...
                        <div class="widget-container-col ui-sortable"  >
                             ...
                             <div class="widget-box widget-color-normal3" style="opacity: 1;">
                                ...
                                <div class="widget-body">
                                  ...
                                  <form class="form-inline form-horizontal" action="<%=request.getContextPath()%>/restrict/seeOperLog" id="searchForm" method="post">
                                    ...
                                    <div class="widget-main no-padding ">
                                        <table class="table table-striped table-bordered table-hover dataTable no-footer DTTT_selectable" id="bankLinkTable">
                                            ...
                                            <tr>
                                               ...
                                               <!--  <th style="text-align:center;width:25%">例外名称</th>
                                                <th style="text-align: center;width: 10%">失效时间</th> -->
