...
<body class="no-skin ">
                                	...
                                	<div class="widget-body">
	                                    <div class="widget-main no-padding ">
	                                        <div class="widget-main ">
	                                            <form class="form-inline form-horizontal" action="<%=request.getContextPath()%>/restExcep/importExcel.do" id="searchForm" method="post"  enctype="multipart/form-data">
	                                              	<input type="hidden" id="orgNm" name="orgNm">
	                                              	<div class=" col-xs-12">
	                                              	<div class="form-group form-group-sm  width-300px">
														<label
															class="col-sm-4 control-label widget-color-normal5 width-100px no-padding-left">归属分公司<font color="red">*</font>:</label>
														<div class="col-sm-8  no-padding">
															<select id="orgNo" name="orgNo"  onchange="findOrgNm()"
    ...
    function findOrgNm(){
        ...
        function returnPage(){
        	location.href = '<%=request.getContextPath() %>/restExcep/batchAddView.do';
        }
