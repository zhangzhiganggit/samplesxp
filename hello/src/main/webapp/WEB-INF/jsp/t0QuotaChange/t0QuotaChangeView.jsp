                                        ...
                                        <form id="searchForm" class="form-inline form-horizontal" action="submitNext.do">
                                            <div class="  col-sm-12">
	                                        	...
	                                        	<label class="control-label widget-color-normal5">
                                                    ...
                                                    当前步骤:<c:if test="${limitChange.taskDefKey == 'createForm'}">发起申请</c:if>
                                                    <c:if test="${limitChange.taskDefKey == 'scDealTask'}">销售公司审批</c:if>
                                                    <c:if test="${limitChange.taskDefKey == 'riskDealTask'}">风险控制部审批</c:if>
                                                    <c:if test="${limitChange.taskDefKey == 'backTask'}">重新发起</c:if>
                                                    &nbsp;&nbsp;任务状态:${taskSts}
                                                </label>
                                                ...
                                                <div class="form-group form-group-sm  width-300px">
                                                    ...
                                                    <div class="col-sm-8  no-padding">
                                                    	<input type="hidden" id="stlSts" value="${limitChange.stlSts}">
                                                    	<label class="form-control input-small width-200px   view-control  "
                                            ...
                                            <div class=" col-sm-12" id="scInfo">
                                                ...
                                                <div class="form-group form-group-sm width-300px">
                                                    ...
                                                    <div class="col-sm-8  no-padding"  >
                                                    	<label class="form-control input-small width-200px   view-control  "
                                                               data-content="<c:if test="${limitChange.scIsSatisfied == 1}">是</c:if><c:if test="${limitChange.scIsSatisfied == 0}">否</c:if>"
                                                                id="scIsSatisfied" data-placement="bottom" data-trigger="hover" data-rel="popover"
                                                ...
                                                <div class="form-group form-group-sm width-100">
                                                    ...
                                                    <div class="col-sm-8 no-padding width-85">
                                                    	<label class="form-control input-small view-control" style="width:500px;height:80px;"
                                                               data-content="${limitChange.scOpinion }" id="scOpinion" data-placement="bottom" data-trigger="hover" data-rel="popover"
											...
											<div class=" col-sm-12" id="riskInfo">
                                                ...
                                                <div class="form-group form-group-sm width-300px">
                                                    ...
                                                    <div class="col-sm-8  no-padding"  >
                                                    	<label class="form-control input-small width-200px   view-control  "
                                                               data-content="<c:if test="${limitChange.riskIsSatisfied == 1}">是</c:if><c:if test="${limitChange.riskIsSatisfied == 0}">否</c:if>"
                                                                id="riskIsSatisfied" data-placement="bottom" data-trigger="hover" data-rel="popover"
                                                                ><c:if test="${limitChange.riskIsSatisfied == 1}">是</c:if><c:if test="${limitChange.riskIsSatisfied == 0}">否</c:if></label>
                                                    </div>
                                                </div>
                                                <div class="form-group form-group-sm width-100">
                                                    <label  class="col-sm-12 control-label widget-color-normal5 width-100px no-padding-left"  >意见*:</label>
                                                    <div class="col-sm-8 no-padding width-85">
                                                    	<label class="form-control input-small view-control  " style="width:500px;height:80px;"
                                                               data-content="${limitChange.riskOpinion }" id="riskOpinion" data-placement="bottom" data-trigger="hover" data-rel="popover"
                                                                >${limitChange.riskOpinion }</label>
                                                    </div>
                                                </div>
                                            </div>
...
<script type="text/javascript">
    ...
    jQuery(function($) {
    	...
    	if('${limitChange.taskDefKey}' == 'createForm' || '${limitChange.taskDefKey}' == 'backTask'){
    		$("#scInfo").attr("style","display:none;");
    		$("#riskInfo").attr("style","display:none;");
    	}else if('${limitChange.taskDefKey}' == 'scDealTask'){
    		$("#riskInfo").attr("style","display:none;");
    		$("[name='scIsSatisfied']").val('${limitChange.scIsSatisfied}');
    	}else if('${limitChange.taskDefKey}' == 'riskDealTask'){
    		$("[name='riskIsSatisfied']").val('${limitChange.scIsSatisfied}');
