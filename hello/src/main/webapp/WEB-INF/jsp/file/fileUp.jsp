                                ...
                                <div class="widget-body">
                                    <div class="widget-main no-padding ">
                                        <div class="widget-main ">
                                            <form  class="form-inline form-horizontal" method="POST" id="serchForm" action="<%=request.getContextPath()%>/file/upload.do" enctype="multipart/form-data"  >
                                                <div class=" col-xs-12">
...
<!--                                                             <input type="text" name="fileGroupId" id="fileGroupId" class="form-control input-small width-200px " data-placement="bottom" title=""   >
 -->                                                   <select id="fileGroupId" name="fileGroupId" data-placeholder="请选择"   class="chosen-select form-control width-200px">
                                                                <option value=""></option>
                                                    ...
                                                    <div class="form-group form-group-sm width-300px">
                                                        ...
                                                        <div class="col-sm-8  no-padding"  >
                                                            <input type="text" name="fileDesc" id="fileDesc" class="form-control input-small width-200px " data-placement="bottom" title=""   >
                                                        </div>
                                                    </div>

                                                    <h3 class="header smaller lighter green">上传信息</h3>
                                                    <div class="form-group col-sm-4 ">
                                                        <label class="ace-file-input ace-file-multiple widget-main" style="height:200px">
                                                            <input type="file" name="myfiles" id="myfiles" class="id-input-file" >
    ...
    jQuery(function($) {
    	...
    	$("#fileGroupId").trigger("chosen:updated");
     	...
     	/*   $.ajax({
				...
				        type: "POST",
				        url:'/file/upload.do',
			        	data : $('#serchForm').serialize(),// 你的formid
						async : false,
						error : function(data) {
							//data = eval("(" + data + ")")
							alert(data);
