                                    ...
                                    <div class="widget-main no-padding ">
                                        <div class="widget-main ">
                                            <form id="searchForm" class="form-inline form-horizontal" action="<%=request.getContextPath()%>/agentExam/addAgentExam.do">
                                                <input type="hidden" id="fileGroupId" name="fileGroupId" value="${fileUp.fileGroupId }">
                                                <div class=" col-xs-12">
                                                    <div class="form-group form-group-sm width-300px ">
                                                        <label  class="col-sm-4 control-label widget-color-normal5 width-100px no-padding-left"  >分类名称:</label>

                                                        <div class="col-sm-8  no-padding"  >
                                                            <input type="text"  id="groupName"  name="groupName"  value="${fileUp.groupName }"   class="form-control input-small width-200px " data-placement="bottom" title=""   >
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-actions center widget-color-normal5">
                                                    <button class="btn btn-danger btn-sm" type="button" id="editType"  >
