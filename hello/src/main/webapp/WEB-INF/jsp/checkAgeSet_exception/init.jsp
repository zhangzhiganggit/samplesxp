...
<head>
    ...
    function operationFun(obj,obj1,obj2){
    	...
    	var url="";
    	if(obj=='update'){
    		url = "<%=base%>checkAgeSet/exceptAgeSetUpdate.do?" + "uuid=" + obj1;
    	}else if(obj=='insert'){
    		url = "<%=base%>checkAgeSet/exceptAgeSetUpdate.do?";
    	}else {
...
<body class="no-skin ">
                                ...
                                <div class="widget-body">
                                    <div class="widget-main no-padding ">
                                        <div class="widget-main ">
                                            <form class="form-inline form-horizontal" action="<%=base%>checkAgeSet/searchExceptCheckAgeSetList" id="searchForm" method="post">
												...
												<div class="form-group form-group-sm width-300px">
                                                    ...
                                                    <div class="form-group form-group-sm width-300px">
														<label
															...
															<div class="col-sm-8  no-padding">
																<select id="exceptEnableState" name="exceptEnableState" class="chosen-select form-control width-200px" >
																	<option value="-1" <c:if test="${checkAgeSet.exceptEnableState == '-1'}">selected="selected"</c:if>>全部</option>
                                                                	<option value="1" <c:if test="${checkAgeSet.exceptEnableState == '1'}">selected="selected"</c:if>>是</option>
																	<option value="0" <c:if test="${checkAgeSet.exceptEnableState == '0'}">selected="selected"</c:if>>否</option>
																</select>
															</div>
													</div>
													<div class="form-group form-group-sm width-300px">
														...
														<div class="col-sm-8  no-padding">
															<input type="text" name="exceptionIdNumber" id="exceptionIdNumber" value="${checkAgeSet.exceptionIdNumber }"  
                                               ...
                                               <button class="btn btn-normal btn-sm" type="submit" >
                                                ...
                                                <span class="ace-icon fa fa-gear icon-on-right bigger-110"></span>  添加
                                                </button>
                                            </form>
                                        </div>
                                    </div>
                                    ...
                                    <div class="widget-main no-padding ">
                                        <table style="word-break:break-all; word-wrap:break-all; " class="table table-striped table-bordered table-hover dataTable no-footer DTTT_selectable">
                                            ...
                                            <tr>
                                                ...
                                                <td align="center">${po.exceptionIdNumber}</td>
    ...
    function resetMecForm(){
	 ...
	 $("#exceptEnableState").val('');
	 $("#exceptEnableState").trigger("chosen:updated");
