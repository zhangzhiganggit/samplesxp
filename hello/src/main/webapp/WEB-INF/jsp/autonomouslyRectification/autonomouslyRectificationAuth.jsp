								...
								<div class="widget-body">
									<div class="widget-main no-padding ">
										<div class="widget-main ">
											<form id="searchForm" class="form-inline form-horizontal" method="post" target="_blank" >
												<input type="hidden" name="flowNo" value="${autonomouslyRectification.flowNo}"/>
												<div class="col-sm-12">
												...
												<div class="col-sm-12">
													...
													<div class="form-group form-group-sm width-300px">
														...
														<div class="col-sm-8  no-padding">
															<input type="text" name="merchantCode" id="merchantCode" value="${autonomouslyRectification.merchantCode }" class="form-control input-small width-200px" readonly="readonly" title=""/>
														</div>
													</div>
												...
												<div class="col-sm-12">
													...
													<div class="form-group form-group-sm width-300px">
														...
														<div class="col-sm-8  no-padding">
															<input type="text" name="registRregistrationNumber" id="registRregistrationNumber" value="${autonomouslyRectification.registRregistrationNumber }" class="form-control input-small width-200px" readonly="readonly" title=""/>
														</div>
													</div>
													<br/>
													<div class="form-group form-group-sm width-300px">
														...
														<div class="col-sm-8  no-padding">
															<input type="text" name="registName" id="registName" value="${autonomouslyRectification.registName }" class="form-control input-small width-200px" readonly="readonly" title=""/>
														</div>
													</div>
													<br/>
													<div class="form-group form-group-sm width-300px">
														...
														<div class="col-sm-8  no-padding">
															<input type="text" name="registAddress" id="registAddress" value="${autonomouslyRectification.registAddress }" class="form-control input-small width-200px" readonly="readonly" title=""/>
														</div>
													</div>
													<br/>						
													<div class="form-group form-group-sm width-300px">
														...
														<div class="col-sm-8  no-padding">
															<input type="text" name="legalPersonName" id="legalPersonName" value="${autonomouslyRectification.legalPersonName }" class="form-control input-small width-200px" readonly="readonly" title=""/>
														</div>
													</div>
													<br/>
													<div class="form-group form-group-sm width-300px">
														...
														<div class="col-sm-8  no-padding">
															<input type="text" name="receiptsName" id="receiptsName" value="${autonomouslyRectification.receiptsName }" class="form-control input-small width-200px" readonly="readonly" title=""/>
														</div>
													</div>
													<br/>
													<div class="form-group form-group-sm width-300px">
														...
														<div class="col-sm-8  no-padding">
															<input type="text" name="manageContent" id="manageContent" value="${autonomouslyRectification.manageContent }" class="form-control input-small width-200px" readonly="readonly" title=""/>
														</div>
													</div>
													<br/>
													<div class="form-group form-group-sm width-300px">
														...
														<div class="col-sm-8  no-padding">
															<input type="text" name="manageAddress" id="manageAddress" value="${autonomouslyRectification.manageAddress }" class="form-control input-small width-200px" readonly="readonly" title=""/>
														</div>
													</div>
													<br/>
													<div class="form-group form-group-sm width-300px">
														...
														<div class="col-sm-8  no-padding">
															<input type="text" name="manageSummary" id="manageSummary" value="${autonomouslyRectification.manageSummary }" class="form-control input-small width-200px" readonly="readonly" title=""/>
														</div>
													</div>
													</div>
													...
													<div class ="div-right">
													<h3 class="header smaller lighter green">商户原信息</h3>
													<div class="form-group form-group-sm width-300px">
														<label for="form-field-6" class="col-sm-4 control-label widget-color-normal5 width-100px no-padding-left"><span style="color: red">*</span>注册登记号:</label>
														<div class="col-sm-8  no-padding">
															<input type="text" name="registRregistrationNumber0" id="registRregistrationNumber0" value="${autonomouslyRectification.registRregistrationNumber0 }" class="form-control input-small width-200px" disabled="disabled" title=""/>
														</div>
													</div>
													<br/>
													<div class="form-group form-group-sm width-300px">
														<label for="form-field-6" class="col-sm-4 control-label widget-color-normal5 width-100px no-padding-left"><span style="color: red">*</span>注册名称:</label>
														<div class="col-sm-8  no-padding">
															<input type="text" name="registName0" id="registName0" value="${autonomouslyRectification.registName0 }" class="form-control input-small width-200px" disabled="disabled" title=""/>
														</div>
													</div>
													<br/>
													<div class="form-group form-group-sm width-300px">
														<label for="form-field-6" class="col-sm-4 control-label widget-color-normal5 width-100px no-padding-left"><span style="color: red">*</span>注册地址:</label>
														<div class="col-sm-8  no-padding">
															<input type="text" name="registAddress0" id="registAddress0" value="${autonomouslyRectification.registAddress0 }" class="form-control input-small width-200px" disabled="disabled" title=""/>
														</div>
													</div>
													<br/>						
													<div class="form-group form-group-sm width-300px">
														<label for="form-field-6" class="col-sm-4 control-label widget-color-normal5 width-100px no-padding-left"><span style="color: red">*</span>法人姓名:</label>
														<div class="col-sm-8  no-padding">
															<input type="text" name="legalPersonName0" id="legalPersonName0" value="${autonomouslyRectification.legalPersonName0 }" class="form-control input-small width-200px" disabled="disabled" title=""/>
														</div>
													</div>
													<br/>
													<div class="form-group form-group-sm width-300px">
														<label for="form-field-6" class="col-sm-4 control-label widget-color-normal5 width-100px no-padding-left">签购单名称:</label>
														<div class="col-sm-8  no-padding">
															<input type="text" name="receiptsName0" id="receiptsName0" value="${autonomouslyRectification.receiptsName0 }" class="form-control input-small width-200px" disabled="disabled" title=""/>
														</div>
													</div>
													<br/>
													<div class="form-group form-group-sm width-300px">
														<label for="form-field-6" class="col-sm-4 control-label widget-color-normal5 width-100px no-padding-left"><span style="color: red">*</span>经营内容:</label>
														<div class="col-sm-8  no-padding">
															<input type="text" name="manageContent0" id="manageContent0" value="${autonomouslyRectification.manageContent0 }" class="form-control input-small width-200px" disabled="disabled" title=""/>
														</div>
													</div>
													<br/>
													<div class="form-group form-group-sm width-300px">
														<label for="form-field-6" class="col-sm-4 control-label widget-color-normal5 width-100px no-padding-left"><span style="color: red">*</span>经营地址:</label>
														<div class="col-sm-8  no-padding">
															<input type="text" name="manageAddress0" id="manageAddress0" value="${autonomouslyRectification.manageAddress0 }" class="form-control input-small width-200px" disabled="disabled" title=""/>
														</div>
													</div>
													<br/>
													<div class="form-group form-group-sm width-300px">
														<label for="form-field-6" class="col-sm-4 control-label widget-color-normal5 width-100px no-padding-left"><span style="color: red">*</span>经营概述:</label>
														<div class="col-sm-8  no-padding">
															<input type="text" name="manageSummary0" id="manageSummary0" value="${autonomouslyRectification.manageSummary0 }" class="form-control input-small width-200px" disabled="disabled" title=""/>
														</div>
													</div>
												</div>
												</div>
												<div class="col-sm-12">
													...
													<div class="form-group form-group-sm width-300px">
														<label for="form-field-6" class="col-sm-4 control-label widget-color-normal5 width-100px no-padding-left"><span style="color: red">*</span>审核结果:</label>
														<div class="col-sm-8  no-padding">
															<input type="radio" name="isAgree" id="isAgree3" value="3" title="" checked="checked"/>&nbsp;通过
															&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
															<input type="radio" name="isAgree" id="isAgree2" value="2" title=""/>&nbsp;不通过
														</div>
													</div>
													<div class="form-group form-group-sm width-100">
                                                        <label  class="col-sm-12 control-label widget-color-normal5 width-100px no-padding-left"  ><span style="color:red;">*</span>具体意见:</label>
                                                        <div class="col-sm-8 no-padding">
												...
												<div class="form-actions center widget-color-normal5">
													<button class="btn btn-danger btn-sm" type="button" onclick="beforeAuthentication()">
