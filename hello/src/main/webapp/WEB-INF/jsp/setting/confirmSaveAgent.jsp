                                ...
                                <div class="widget-body">
                                    <div class="widget-main no-padding ">
                                        <div class="widget-main ">
                                            <form id="searchForm" class="form-inline form-horizontal" method="post" action="<%=request.getContextPath() %>/org/continueToModify.do">
                                                     ...
                                                     <div class="form-group form-group-sm width-100 ele">
                                                        ...
                                                        <div class="col-sm-8  no-padding width-85"  >
                                                            <label class="form-control input-small width-100   view-control  "
                                                                   data-content="${org.provNm }${org.cityNm }${org.orgAddr }" data-placement="bottom" data-trigger="hover" data-rel="popover"
                                                                    >${org.provNm } ${org.cityNm } ${org.orgAddr }</label>
                                                        </div>
                                                    </div>
<!--                                                      <div class="form-group form-group-sm width-300px "> -->
<!--                                                          <div class="col-sm-8  no-padding"  > -->
...
<c:if test="${pbCheck==false }">
						...
						</c:if>							<div class="form-group form-group-sm width-300px ele">
														<label
...
<!--                                                     </div> -->
    ...
    <script type="text/javascript">
	    function confirmSaveOrg(){
		    	$('#searchForm').attr("action","<%=request.getContextPath() %>/org/saveResult.do")
