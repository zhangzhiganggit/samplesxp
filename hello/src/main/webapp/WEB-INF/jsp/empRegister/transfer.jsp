								...
								<div class="widget-body">
									<div class="widget-main no-padding ">
										<div class="widget-main ">
											<form id="submitForm" class="form-inline form-horizontal" method="post" target="_blank" action="<%=request.getContextPath()%>/empRegister/transfer">
													...
													<table
														...
														<c:forEach items="${empRegisterList }" var="empRegister" varStatus="status">
															<tr style="border: 1px solid #969696;">
																<td align="center">${empRegister.empNo }</td>
																<td align="center">${empRegister.empNm }</td>
																<td align="center">
																...
																<td align="center">${empRegister.mbNo }</td>
																<td><fmt:formatDate value="${empRegister.registerDt }" pattern="yyyy-MM-dd HH:mm:ss"/></td>
																<td>${empRegister.authenticationStatusStr }</td>
															</tr>
														</c:forEach>
													</table>
												</div>
