                                            ...
                                            <form id="searchForm" class="form-inline form-horizontal" action="list.html">
                                             ...
                                             <input type="hidden" id="orgNo" name="orgNo" value="${orgNo}">
                                                ...
                                                <div class=" col-xs-12">
                                                    ...
                                                    <div class="form-group form-group-sm width-300px ">
                                                        ...
                                                        <input type="hidden" name="switchFlag" id="switchFlag" value="${switchFlag }">
                                                            ...
                                                            <c:if test="${switchFlag == 1 }">checked onclick="return false"</c:if>
                                                            <c:if test="${switchFlag != 1 }"> onchange="switchFunc();"</c:if>
                                                            >
                                                            <span class="lbl">&nbsp;</span>
                                                        </div>
                                                    </div>
                                                ...
                                                <c:forEach items="${levelList }" var="lv">
                                                 ...
                                                 <input type="hidden" id="hid" name="hid" value="${lv.id}">
                                                   <div class="col-sm-12">
                                           ...
                                           <div class="form-group form-group-sm width-300px">
                                                    ...
                                                    <div class="form-group form-group-sm width-300px">
                                                        ...
                                                        <div class="col-sm-8  no-padding"  >
                                                           ...
                                                           <c:if test="${lv.levelOrder!=lv.maxOrder }">
                                                           <input type="text" id="up_${lv.levelOrder}" name="upMoney" readonly="readonly" value="${lv.upMoneyView }" onblur="setLowMoney('${lv.levelOrder}')" onchange="setLowMoney('${lv.levelOrder}')" class="numberFormat" >
                                                           </c:if>
                                                        </div>
                                                    </div>
                                                    <div class="form-group form-group-sm width-300px">
                                               ...
                                               <div class="form-actions center widget-color-normal5">
                                                    <button class="btn btn-danger btn-sm" type="button" onclick="updateOrg();">
	  ...
	  for (var i=min;i<max-1;i++)
	   {
	      ...
	      var m = i+1;
	      var upMoneyB = $("#up_"+m).val();
	      var upMoneyInt = parseInt(upMoney.replace(/,/g,''));
	      var upMoneyBInt = parseInt(upMoneyB.replace(/,/g,''));
	      var lowMoneyInt = parseInt(lowMoney);
	      if(upMoneyBInt<upMoneyInt){
	    	  alert("等级"+m+"的上限金额不能低于等级"+i+"的上限金额");
	    	  return;
	      }
	      if(upMoneyInt<=lowMoneyInt){
	    	  alert("等级"+i+"的上限金额必须大于等级"+i+"的下限金额");
	    	  return;
	      }
