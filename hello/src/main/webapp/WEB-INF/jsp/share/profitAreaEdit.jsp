                                           ...
                                           <div class="form-group form-group-sm width-300px">
                                                    ...
                                                    <div class="form-group form-group-sm width-300px">
                                                        ...
                                                        <div class="col-sm-8  no-padding"  >
                                                           ...
                                                           <c:if test="${lv.levelOrder!=lv.maxOrder }">
                                                           <input type="text" id="up_${lv.levelOrder}" name="upMoney" value="${lv.upMoneyView }"  onchange="setLowMoney('${lv.levelOrder}')" class="numberFormat" >
                                                           </c:if>
                                                        </div>
                                                    </div>
                                                    <div class="form-group form-group-sm width-300px">
...
<input type="hidden" id="provCd" name="provCd" value="${provCd }">
                                                <div class="row"></div>
                                               <div class="form-actions center widget-color-normal5">
                                                    <button class="btn btn-danger btn-sm" type="button" onclick="updateArea();">
	  ...
	  for (var i=min;i<max-1;i++)
	   {
	      ...
	      var m = i+1;
	      var upMoneyB = $("#up_"+m).val();
	      var upMoneyInt = parseInt(upMoney);
	      var upMoneyBInt = parseInt(upMoneyB);
