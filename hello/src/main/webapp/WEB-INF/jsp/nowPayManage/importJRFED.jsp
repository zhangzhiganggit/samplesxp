                                	...
                                	<div class="widget-body">
	                                    <div class="widget-main no-padding ">
	                                        <div class="widget-main ">
	                                            <form class="form-inline form-horizontal" action="<%=request.getContextPath()%>/nowPayManage/importJRFEDExcel" id="importForm" method="post"  enctype="multipart/form-data">
	                                              	<div class=" col-xs-12">
   ...
   <%@include file="../layout/common.alljs.jsp"%>
    <script type="text/javascript">
        ...
        function returnImportOrderPage(){
        	location.href = '<%=request.getContextPath() %>/nowPayManage/toImportJRFEDView';
        }
