                                        ...
                                        <div class="widget-main ">
                                            <form id="editJRFflForm" class="form-inline form-horizontal" action="<%=request.getContextPath()%>/mecIfDayPay/editJRFfl" method="post">
                                                ...
                                                <div class=" col-xs-12">
                                                	<div class="col-sm-12 form-group form-group-sm width-400px ">
                                                		<div class="col-sm-1"  ></div>
                                                        <label  class="col-sm-4 control-label widget-color-normal5 width-100px no-padding-left"  >当前即日付费率</label>

                                                        <div class="col-sm-7  "  >
                                                            <input type="text" class="col-sm-11"  id="jrfflnow" readonly="readonly"  name="cprRegNmCn"  value="${mf.jrrffl }"  class="form-control input-small width-400px " data-placement="bottom" title=""   >
                                                            <span class="col-sm-1 no-padding-left" style="top: 6px;font-size: large;">%</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class=" col-xs-12">
                                                	<div class="col-sm-12 form-group form-group-sm width-400px ">
                                                		<div class="col-sm-1"  ></div>
                                                        <label  class="col-sm-4 control-label widget-color-normal5 width-100px no-padding-left"  >新即日付费率<font color="red">*</font></label>

                                                        <div class="col-sm-7 "  >
                                                            <input type="text" class="col-sm-11" id="jrffl"  name="jrffl"  value=""  class="form-control input-small width-400px " data-placement="bottom" title=""   >
                                                            <span class="col-sm-1 no-padding-left" style="top: 6px;font-size: large;">%</span>
                                                        </div>
                                                    </div>
                                                </div>
 ...
 <%@include file="../layout/common.alljs.jsp"%>
	...
	function validate() {
		...
		$.ajax({
	    	type: "POST",
	    	async:false,
	        url: "/nowPayManage/editJRFfl?mno="+mno+"&jrffl=" + jrffl,
