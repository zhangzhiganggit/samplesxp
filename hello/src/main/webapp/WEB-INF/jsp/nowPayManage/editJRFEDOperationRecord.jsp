							...
							<div class="widget-box widget-color-normal3">
								<div class="widget-header">
									<h5 class="widget-title bigger lighter">
										<i class="ace-icon fa fa-table"></i> 商户即日付修改额度记录
									</h5>
								</div>
										...
										<table
											...
											<thead class="thin-border-bottom">
												<tr>
													...
													<th style="text-align: center; width: 6%">修改前额度</th>
													<th style="text-align: center; width: 6%">修改后额度</th>
											...
											<tbody>
												<c:forEach items="${mecIfJrfList }" var="mecIfJrf"
													...
													<tr>
		                                                ...
		                                                <td style="text-align: center;">${mecIfJrf.mecName }</td>
		                                                <td style="text-align: center;">${mecIfJrf.beforeLimit }</td>
		                                                <td style="text-align: center;">${mecIfJrf.afterLimit}</td>
		                                                <td style="text-align: center;">${mecIfJrf.stffName}</td>
		                                                <td style="text-align: center;">${mecIfJrf.sysName }</td>
		                                                <td style="text-align: center;">${mecIfJrf.dtCte} ${mecIfJrf.tmCte}</td>
													</tr>
												</c:forEach>
											</tbody>
										</table>
