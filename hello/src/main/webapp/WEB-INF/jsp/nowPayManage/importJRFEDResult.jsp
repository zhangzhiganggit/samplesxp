...
<body class="no-skin " >
                ...
                <div class="page-content ">
                    <div class="row" >
                                    ...
                                    <div class="widget-main no-padding ">
                                        <table class="table table-striped table-bordered table-hover dataTable no-footer DTTT_selectable" id="bankLinkTable">
                                            ...
                                            <tr>
                                                ...
                                                <th style="text-align: center;width: 15%">修改后额度</th>
                       ...
                       <div class="row no-margin">
							...
							<form  action="<%=request.getContextPath()%>/nowPayManage/downLoadJRFEDResult" id="downLoadResultForm" method="post">
                                            </form>
                    </div>
                </div>
            </div>
    ...
    function submitFunc() {
    	...
    	document.getElementById("resultForm").action = "<%=request.getContextPath()%>/nowPayManage/importJRFEDExcel?resultPageNum=" + resultPageNum+"&resultPageSize=" + resultPageSize + "&resultCache=1";
