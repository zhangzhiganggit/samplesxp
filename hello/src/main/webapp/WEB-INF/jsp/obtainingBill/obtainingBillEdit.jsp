                                    ...
                                    <div class="widget-main no-padding ">
                                        <div class="widget-main ">
                                            <form id="obtainingBillForm" class="form-inline form-horizontal" action="submitNext.do" method="post">
                                            	<input type="hidden" id="procDefKey" value="obtainingDocInfo"/>
                                                ...
                                                <div class=" col-sm-12">
                                                    ...
                                                    <div class="form-group form-group-sm width-100">
                                                        ...
                                                        <div class="col-sm-8 no-padding ">
                                                            <textarea name="cityAgentSign" id="cityAgentSign" style="height:80px"  class="form-control limited input-small width-100"></textarea>
                                                        </div>
                                                    </div>
                                                </div>

                                                <div class=" col-sm-12">
                                                    <div id="uploadImageResult">
                                              		</div>
                                                    <button class="btn btn-danger btn-sm" type="button" id="uploadImage">
