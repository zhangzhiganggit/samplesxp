...
<body class="no-skin ">
                                	...
                                	<div class="widget-body">
	                                    <div class="widget-main no-padding ">
	                                        <div class="widget-main ">
	                                            <form class="form-inline form-horizontal" action="<%=request.getContextPath()%>/MerchantComplianceManage/importRecord" id="searchForm" method="post"  enctype="multipart/form-data">
	                                              	<div class=" col-xs-12">
	                                                    <h3 class="header smaller lighter green">选择Excel导入,每次导入的数量不可超过10000条</h3>
    ...
    <script type="text/javascript">
        ...
        function returnImportOrderPage(){
        	location.href = '<%=request.getContextPath() %>/MerchantComplianceManage/importView';
        }
