...
<body class="no-skin ">
                        ...
                        <div class=" widget-container-col ui-sortable  "  >
                            ...
                            <div class="widget-box widget-color-normal2" style="opacity: 1;">
                                ...
                                <div class="widget-body">
                                     <font size="3" color="red">本次批量导入商户追偿信息共${totalNum }条,成功${sucNum }条,失败${failNum }条,失败原因如下</font>
   ...
   <%@include file="../layout/common.alljs.jsp"%>
    ...
    function closeThisWin(){
    	location.href = "<%=request.getContextPath() %>/MerchantComplianceManage/toQueryMercComplianceList";
