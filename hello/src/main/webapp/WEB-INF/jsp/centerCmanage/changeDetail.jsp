                                ...
                                <div class="widget-body">
                                    <div class="widget-main no-padding ">
                                        <div class="widget-main ">
                                            <form id="searchForm" class="form-inline form-horizontal" method="post" action="">
                                            <input type="hidden" name="targetUuid" value="${his.targetUuid }">
                                                <div class=" col-xs-12">
                                                    <div class="form-group form-group-sm width-300px ">
                                                        <label  class="col-sm-4 control-label widget-color-normal5 width-100px no-padding-left"  >审单人员账号:</label>
                                                    ...
                                                    <div class="form-group form-group-sm width-300px ">
                                                        ...
                                                        <div class="col-sm-8  no-padding"  >
                                                            <label class="form-control input-small width-200px   view-control  "
                                                                   data-content="${his.updateTimeStr }" data-placement="bottom" data-trigger="hover" data-rel="popover"
                                                                    >${his.updateTimeStr }</label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group form-group-sm width-300px ">
                                                        ...
                                                        <div class="col-sm-8  no-padding"  >
                                                            <label class="form-control input-small width-200px   view-control  "
                                                                   data-content="${his.empNm }" data-placement="bottom" data-trigger="hover" data-rel="popover"
                                                                    >${his.empNm }</label>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-actions center widget-color-normal5">
	                     							<button class="btn  btn-sm" type="button" onclick="window.history.back();">
