...
<div class="main-container" id="main-container">
									...
									<div class="widget-main no-padding ">
										<div class="widget-main ">
											<form id="searchForm" class="form-inline form-horizontal"
												...
												<input type="hidden" name="imgUrl" id="imgUrl" value="${imageUrl }">
												<div class=" col-xs-12">
													...
													<div class="form-group form-group-sm width-100">
														...
														<div class="col-sm-8  no-padding width-70">
															<input type="text" maxlength="100" name="adverUrl"
																 id="adverUrl"  maxlength="100" value="${adverUrl }"
																class="form-control input-small width-100 "
														...
														<div class="col-sm-8  no-padding">
															<div class="col-sm-8  no-padding">
																<select id="adverStatus" name="adverStatus"
																	...
																	<c:if test="${adverStatus==0}">
																	<option value="0"  selected="selected">请选择</option>
																	<option value="1">启用</option>
																	<option value="2">停用</option>
																	</c:if>
																	<c:if test="${adverStatus==1 }">
																		<option value="0">请选择</option>
																	<option value="1"  selected="selected">启用</option>
																	<option value="2">停用</option>
																	</c:if>
																	<c:if test="${adverStatus==2 }">
																		<option value="0">请选择</option>
																	<option value="1">启用</option>
                                                ...
                                                <c:if test="${imageUrl!=null}">
		                                                 <div class="form-group form-group-sm width-100 ">
		                                                        <label  class="col-sm-4 control-label widget-color-normal5 width-100px no-padding-left"  >图片信息:</label>
													                 <div class="col-sm-8  no-padding width-70">
																	<a href="#" class="menuitem"><img class="1" name='1' src="<%=request.getContextPath() %>/flow/loadimg?address=${imageUrl}"   width="100px" height="100px"  onclick='enlargeImg("<%=request.getContextPath() %>/flow/loadimg?address=${imageUrl}","1","1")'></a>
																</div>
		                                                </div>
                                                </c:if> 
	...
	<script type="text/javascript">
	function fan(){
		location.href="/flow/advertisement?entry=1";
	}
