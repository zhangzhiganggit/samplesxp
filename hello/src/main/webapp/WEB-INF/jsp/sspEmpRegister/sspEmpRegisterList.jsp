...
<body class="no-skin ">
								...
								<div class="widget-body">
									<div class="widget-main no-padding ">
										<div class="widget-main ">
											<form class="form-inline form-horizontal" action="<%=request.getContextPath()%>/sspEmpRegister/sspEmpRegisterList.do?entry=1"
												...
												<div class=" col-xs-12">
													<div class="form-group form-group-sm width-300px">
														...
														<div class="col-sm-8  no-padding">
															<input type="text" name="empNm" id="empNm" value="${sspEmpRegister.empNm }" class="form-control input-small width-200px" data-placement="bottom" title="" >
														</div>
													</div>
													<div class="form-group form-group-sm width-300px">
														<label for="form-field-6" class="col-sm-4 control-label widget-color-normal5 width-100px no-padding-left">业务员手机号:</label>
														<div class="col-sm-8  no-padding">
															<input type="text" name="mbNo" id="mbNo" value="${sspEmpRegister.mbNo }" class="form-control input-small width-200px" data-placement="bottom" title="" >
														</div>
													</div>
													<div class="form-group form-group-sm width-300px">
														<label for="form-field-6" class="col-sm-4 control-label widget-color-normal5 width-100px no-padding-left">直属机构名称:</label>
														<div class="col-sm-8  no-padding">
															<input type="text" name="orgNm" id="orgNm" value="${sspEmpRegister.orgNm }" class="form-control input-small width-200px" data-placement="bottom" title="" >
														</div>
													</div>
													<div class="form-group form-group-sm width-300px">
														<label for="form-field-6" class="col-sm-4 control-label widget-color-normal5 width-100px no-padding-left">直属机构编号:</label>
														<div class="col-sm-8  no-padding">
															<input type="text" name="orgUuid" id="orgUuid" value="${sspEmpRegister.orgUuid }" class="form-control input-small width-200px" data-placement="bottom" title="" >
														</div>
													</div>
													<div class="form-group form-group-sm width-300px ">
														...
														<div class="col-sm-8  no-padding">
															<select data-placeholder="请选择" name="areaProv" id="areaProv" onchange="changeProv()" class="chosen-select form-control width-200px">
																...
																<c:forEach items="${provList }" var="prov">
																	<option value="${prov.AREA_ID }" <c:if test="${sspEmpRegister.areaProv==prov.AREA_ID}">selected</c:if>>${prov.AREA_NM }</option>
																</c:forEach>
																</c:if>
															</select>
														</div>
														...
														<div class="col-sm-8  no-padding">
															<select data-placeholder="请选择" name="areaCity" id="areaCity" onchange="changeCity()" class="chosen-select form-control width-200px">
																...
																<c:forEach items="${cityList }" var="city">
																	<option value="${city.AREA_ID }" <c:if test="${sspEmpRegister.areaCity==city.AREA_ID}">selected</c:if>>${city.AREA_NM }</option>
																</c:forEach>
																</c:if>
															</select>
														</div>
													...
													<div class="form-group form-group-sm width-300px ">
														...
														<div class="col-sm-8   no-padding">
															<div class="input-daterange input-group width-200px">
																<input type="text" name="registerDtStart" value="${sspEmpRegister.registerDtStart }" id="registerDtStart" onchange="changeRegisterDtStart()" class="input-small form-control">
																<span class="input-group-addon"><i class="fa fa-exchange"></i></span> 
																<input type="text" name="registerDtEnd" value="${sspEmpRegister.registerDtEnd }" id="registerDtEnd" onchange="changeRegisterDtEnd()" class="input-small form-control">
															</div>
														</div>
													</div>				
													<div class="form-group form-group-sm width-300px ">
														...
														<div class="col-sm-8  no-padding">
															<select data-placeholder="请选择" name="isTransfer" id="isTransfer" class="chosen-select form-control width-200px">
																<option value="" >全部</option>
																<option value="0" <c:if test="${sspEmpRegister.isTransfer=='0' }">selected</c:if>>划拔前</option>
																<option value="1" <c:if test="${sspEmpRegister.isTransfer=='1' }">selected</c:if>>划拔后</option>
															</select>
														</div>
													</div>
													<div class="form-group form-group-sm width-300px ">
														...
														<div class="col-sm-8  no-padding">
															<select data-placeholder="请选择" name="authenticationStatus" id="authenticationStatus" class="chosen-select form-control width-200px">
																<option value="" >全部</option>
																<option value="1" <c:if test="${sspEmpRegister.authenticationStatus=='1' }">selected</c:if>>实名认证通过</option>
																<option value="0" <c:if test="${sspEmpRegister.authenticationStatus=='0' }">selected</c:if>>实名认证未通过</option>
															</select>
														</div>
													</div>
												</div>
	                                            ...
	                                            <c:forEach items="${sspEmpRegisterList }" var="sspEmpRegister" varStatus="status">
	                                            	<tr>
	                                            		...
	                                            		<td style="text-align: center; width: 5%">
		                                            		<div>
																<label> 
																	<input type="checkbox" value="${sspEmpRegister.uuid }">
																	<span class="lbl"></span>
																</label>
															</div>
														</td>
														</c:if>
														<td style="text-align: center;">${sspEmpRegister.empNo }</td>
														<td style="text-align: center;">${sspEmpRegister.empNm }</td>
														<td style="text-align: center;" id="mbNoStr${status.index }" onclick="showMbNo('${status.index }');">${sspEmpRegister.mbNoStr }</td>
														<td style="text-align: center;" hidden="hidden" id="mbNo${status.index }" >${sspEmpRegister.mbNo}</td>
														...
														<td style="text-align: center;">
															<c:if test="${sspEmpRegister.orgUuid == '0000000000' || sspEmpRegister.orgUuid == null }"></c:if>
															<c:if test="${sspEmpRegister.orgUuid != '0000000000' && sspEmpRegister.orgUuid != null }">${sspEmpRegister.orgUuid }</c:if>
														</td>
														<td style="text-align: center;">${sspEmpRegister.authenticationStatusStr }</td>
														<td style="text-align: left;">${sspEmpRegister.areaProvNm }${sspEmpRegister.areaCityNm }${sspEmpRegister.areaCounNm }</td>
														<td style="text-align: center;"><fmt:formatDate value="${sspEmpRegister.registerDt }" pattern="yyyy-MM-dd HH:mm:ss"/></td>
														<td style="text-align: center;">${sspEmpRegister.roleUuidStr }</td>
														<td style="text-align: center;">${sspEmpRegister.isTransferStr }</td>
														<td align="left">
															<div class="action-buttons">
																<a href="#" onclick="showSspEmpRegisterLog('${sspEmpRegister.uuid}')" class="blue fancybox-manual-b">
	...
	<script type="text/javascript">
	var prov= '${sspEmpRegister.areaProv}';
	var city= '${sspEmpRegister.areaCity}';
	var coun= '${sspEmpRegister.areaCoun}';
	function changeProv(){
		var areaProv= $("#areaProv").val();
		...
		$.ajax({
			cache : true,
			type : "POST",
			url : '/sspEmpRegister/getAreaCity',
	...
	function changeCity(){
		...
		$.ajax({
			cache : true,
			type : "POST",
			url : '/sspEmpRegister/getAreaCoun',
