                    ...
                    <div class="row" >
                        ...
                        <div class=" widget-container-col ui-sortable  "  >
                            ...
                            <div class="widget-box widget-color-normal2" style="opacity: 1;">
                                ...
                                <c:if test="${sucess!= null && sucess ne '' }">
                                <div class="widget-body">
                                     <font size="3" color="red">${sucess }</font>
                                </div>
                                </c:if>
                                <c:if test="${(failList)!= null && fn:length(failList) > 0}">
                                <div class="widget-body">
                                    <font size="3" color="red">本次批量导入共${totalNum }条,错误数据失败原因如下
                                        <c:if test="${error_down== true }"><a href="/SimCard/excelErrorDown">错误明细下载</a></c:if> </font>
                                    <div class="widget-main no-padding ">
                                        <table class="table table-striped table-bordered table-hover dataTable no-footer DTTT_selectable">
                                            <thead class="thin-border-bottom">
                                            <tr>
                                                <th align="center" style="width: 10%">编号</th> 
                                                <th style="width: 30%"> 错误数据所在行数</th>
                                                <th > 失败原因</th>
                                            </tr>
                                            </thead>
