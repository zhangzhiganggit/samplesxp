...
<body class="no-skin ">
							...
							<div class="widget-box widget-color-normal3" style="opacity: 1;">
								<div class="widget-header">
									<h5 class="widget-title bigger lighter">
										<i class="ace-icon fa fa-table"></i>发布操作
									</h5>
									<h6 class="widget-title bigger lighter white">
										（提示：过滤机构不执行一键操作，多个过滤机构请用回车符分隔）</h6>
								</div>
												...
												<input hidden="hidden" name="uuid" id="uuid">
													...
													<div class="form-actions center widget-color-normal5">
														...
														<button class="btn btn-default btn-sm" type="reset"
															onclick="clean();">
															<span class="ace-icon fa fa-search-minus icon-on-right bigger-110"></span>清空过滤机构</button>
												</div>
											</form>
										</div>
									</div>
	...
	$(function(){
		...
		function publishAgentProfit(){
            ...
            $.ajax({
                url:"<%=request.getContextPath()%>/orgTradeSumNew/publishAgentProfit",
                type:"POST",
