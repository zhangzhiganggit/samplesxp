...
<body class="no-skin ">
                                ...
                                <div class="widget-body">
                                    <div class="widget-main no-padding ">
                                        <div class="widget-main ">
                                            ...
                                            <form class="form-inline form-horizontal" action="<%=request.getContextPath()%>/empTradeSum/empList.do" id="searchForm" method="post">
                                                ...
                                                <c:if  test="${loginUserPermission.SMSA_PROFIT_032!=null}"> 
                                                 <button id="exp" class="btn btn-primary btn-sm" type="button" onclick="uploadExcelEmp()">
                                    ...
                                    <div class="widget-main no-padding ">
                                        <table class="table table-striped table-bordered table-hover dataTable no-footer DTTT_selectable">
                                            ...
                                            <tr>
                                                ...
                                                <th style="text-align: center;width: 11%">机构名称</th>
                                                <th style="text-align: center;width: 9%">交易日期</th>
                                                <th style="text-align: center;width: 10%">交易金额合计</th>
                                                <th style="text-align: center;width: 9%">非封顶金额合计</th>
                                                <th style="text-align: center;width: 9%">手续费合计</th>
                                                <th style="text-align: center;width: 9%">可分润金额合计</th>
                                                <th style="text-align: center;width: 9%">分润金额合计</th>
														...
														<td style="text-align: right;"class="numberFormat" >${de.tradeCount }</td>
														 <td style="text-align: left;">
										                     <div class="   action-buttons">
										                         <a href="#" onclick="typeDetailShow('${de.empNo }','${de.tranDtStr }')" class="blue fancybox-manual-b">
    ...
    function uploadExcelEmp(){
		$("#searchForm").attr("action","<%=request.getContextPath()%>/profitExport/EmpExcelDown.do");
		if(valiDt()){
			document.getElementById("exp").disabled=true;
			document.getElementById("searchForm").submit();
		}
		$("#searchForm").attr("action","<%=request.getContextPath()%>/empTradeSum/empList.do");
