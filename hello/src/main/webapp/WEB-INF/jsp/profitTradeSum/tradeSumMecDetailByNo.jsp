...
<body class="no-skin ">
                                   ...
                                   <input type="hidden" id="flg" name="flg" value="1" >           
                                    <div class="widget-main no-padding ">
                                        <table class="table table-striped table-bordered table-hover dataTable no-footer DTTT_selectable" id="bankLinkTable">
                                            ...
                                            <tr>
                                                <th style="text-align: center;width: 7%">月份</th>
                                            	...
                                            	<c:forEach var="de" items="${mecSumList}" varStatus="status">
                                            		<tr>
		                                                ...
		                                                <div class="   action-buttons">
								                                  <a href="#" onclick="typeDetailShow('${de.inMno}','${year}','${month}','${de.mno }','${de.mecDisNm }','${de.mecOperNm }')" class="blue fancybox-manual-b">
    ...
    function typeDetailShow(id,year,month,mno,mecDisNm,mecOperNm){
  	  $.fancybox.open({
				href : '<%=request.getContextPath() %>/mecTradeSum/mecTypeMonthList.do?inMno='+id+'&year='+year+'&month='+month+'&mno='+mno+'&mecDisNm='+mecDisNm+'&mecOperNm='+mecOperNm,
				type: 'iframe',
	        padding: 5,
	        scrolling: 'no',
	        fitToView: true,
