...
<body class="no-skin ">
                                ...
                                <div class="widget-body">
                                    <div class="widget-main no-padding ">
                                        <div class="widget-main ">
                                            <form class="form-inline form-horizontal" action="<%=request.getContextPath()%>/orgTradeSum/orgMonthList.do" id="searchForm" method="post">
                                                ...
                                                <c:if  test="${loginUserPermission.SMSA_PROFIT_031!=null}">
                                                <button id="exp" class="btn btn-primary btn-sm" type="button" onclick="uploadExcelOrgMonth()">
                                ...
                                <div class="widget-body">
                                    <div class="widget-main no-padding ">
                                        <table class="table table-striped table-bordered table-hover dataTable no-footer DTTT_selectable">
                                            ...
                                            <tr>
                                                <th style="text-align: center;width: 4%">月份</th>
														 ...
														 <td style="text-align: left;">
										                     <div class="   action-buttons">
										                         <a href="#" onclick="typeDetailShow('${de.orgNo }','${year}','${month}')" class="blue fancybox-manual-b">
										                             <i class="ace-icon fa fa-search-plus blue bigger-130"><font size="2">机构日详情</font></i>
										                         </a>
										                         <a href="#" onclick="orgDetailShow('${de.orgNo }','${year}','${month}')" class="blue fancybox-manual-b">
										                          ...
										                          <a href="#" onclick="empDetailShow('${de.orgNo }','${year}','${month}')" class="blue fancybox-manual-b">
										                             <i class="ace-icon fa fa-search-plus blue bigger-130"><font size="2">业务员月详情</font></i>
										                         </a>
										                     </div>
										                 </td>
													</tr>
    ...
    function uploadExcelOrgMonth(){
    	var profitMonth = $("#profitMonth").val();
    	if(profitMonth=='' || profitMonth==null){
    		alert("请选择月份");
    		return;
    	}
		$("#searchForm").attr("action","<%=request.getContextPath()%>/profitExport/OrgMonthExcelDown.do");
		document.getElementById("exp").disabled=true;
		document.getElementById("searchForm").submit();
		$("#searchForm").attr("action","<%=request.getContextPath()%>/orgTradeSum/orgMonthList.do");
	}
      ...
      function typeDetailShow(id,year,month){
    	  $.fancybox.open({
				href : '<%=request.getContextPath() %>/orgTradeSum/orgOneListByEmpNo.do?orgNo='+id+'&year='+year+'&month='+month,
				type: 'iframe',
	        padding: 5,
	        scrolling: 'no',
	        fitToView: true,
      ...
      function empDetailShow(id,year,month){
    	  var profitMonth = year+'-'+month;
    	  $.fancybox.open({
				href : '<%=request.getContextPath() %>/empTradeSum/empMonthList.do?orgNo='+id+'&profitMonth='+profitMonth+'&flg=1',
				type: 'iframe',
	        padding: 5,
	        scrolling: 'no',
	        fitToView: true,
