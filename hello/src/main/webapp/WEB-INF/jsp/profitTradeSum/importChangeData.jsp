...
<body class="no-skin ">
                                	...
                                	<div class="widget-body">
	                                    <div class="widget-main no-padding ">
	                                        <div class="widget-main ">
	                                            <form class="form-inline form-horizontal" action="<%=request.getContextPath()%>/profitImport/importChangeExcel" id="searchForm" method="post"  enctype="multipart/form-data">
	                                              	<div class=" col-xs-12">
	                                ...
	                                <div class="widget-body">
	                                    <div class="widget-main no-padding " id="batchStartResultInfo">
	                                    	<c:if test="${resultMap.readStatus == 'error'}">
	                                    		<h3 class=" smaller lighter red" style="padding-left:5px;">Excel部分数据更新失败，错误信息如下：</h3>
	                                    		<h5 class="header smaller lighter red">${resultMap.errorMsg}</h5>
	                                    		<h4>
	                                    		
	                                    		<c:forEach items="${errorList }" var="errorMap">
	                                    		机构编号：${errorMap.REASON }<br/>
	                                    	...
	                                    	<c:if test="${resultMap.readStatus == 'right'}">
	                                    		<h3 class=" smaller lighter red" style="padding-left:5px;">Excel导入结果：数据更新成功</h3>
	                                    		<h5 class="header smaller lighter red">${resultMap.errorMsg}</h5>
	                                    		<div class="form-actions center widget-color-normal5">
                                                    <button class="btn btn-default btn-sm" type="button" onclick="returnImportOrderPage()" id="btnReturn">
                                                        <span class="ace-icon fa fa-power-off icon-on-right bigger-110"></span>
    ...
    <script type="text/javascript">
        ...
        function returnImportOrderPageb(){
        	location.href = '<%=request.getContextPath()%>/profitImport/changeData';
        }
