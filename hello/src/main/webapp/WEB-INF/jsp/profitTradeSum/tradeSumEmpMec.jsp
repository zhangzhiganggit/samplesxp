                          ...
                          <div class="widget-container-col ui-sortable"  >
                             <div class="widget-box widget-color-normal3" style="opacity: 1;">
                                ...
                                <form class="form-inline form-horizontal" action="<%=request.getContextPath() %>/mecTradeSum/mecList.do" id="searchForm" method="post">
                                   ...
                                   <input type="hidden" id="tranDtStr" name="tranDtStr" value="${dsm.tranDtStr}" >
...
<!--                                                 <th style="text-align: center;width: 10%">操作</th>
 -->                                            </tr>
                                              ...
                                              <tbody>
                                            	<c:forEach var="tl" items="${mecSumList}" varStatus="status">
                                            		<tr>
		                                                <td style="text-align: center;">${tl.mno }</td>
		                                                <td style="text-align: left;">${tl.mecDisNm }</td>
		                                                <td style="text-align: left;">${tl.mecOperNm }</td>
		                                                ...
		                                                <div class="   action-buttons">
								                                  <a href="#" onclick="typeDetailShow('${tl.inMno}','${tl.tranDtStr }','${tl.mno }','${tl.mecDisNm }','${tl.mecOperNm }')" class="blue fancybox-manual-b">
