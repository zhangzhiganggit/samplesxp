...
<body class="no-skin ">
							...
							<div class="widget-box widget-color-normal3" style="opacity: 1;">
								<div class="widget-header">
									<h5 class="widget-title bigger lighter">
										<i class="ace-icon fa fa-table"></i>操作全部（提示：过滤机构不执行一键操作，多个过滤机构请用回车符分隔）
									</h5>
								</div>
									...
									<div class="widget-main no-padding ">
										<div class="widget-main ">
											<form id="suggestionForm" class="form-inline form-horizontal"
												action="<%=base%>orgTradeSum/operAllAgentProfit"
												...
												<div class="widget-box widget-color-normal2"
													...
													<div class="form-actions center widget-color-normal5">
														<button class="btn btn-danger btn-sm" type="button" onclick="publishAgentProfit()">
															<span
																class="ace-icon fa fa-floppy-o icon-on-right bigger-110"></span>
															一键发布
														</button>
														<button class="btn btn-normal btn-sm" type="reset"
	...
	$(function(){
		...
		function publishAgentProfit(){
			var profitMonth = $("#profitMonth").val();
			var exceptOrgNoArray = $("#exceptOrgNoArray").val();
			
            $.ajax({
                url:"<%=request.getContextPath()%>/orgTradeSum/publishAgentProfit",
                type:"POST",
                data:{"profitMonth":profitMonth,"exceptOrgNoArray":exceptOrgNoArray},
                dataType:"json",
                async:false,
                beforeSend:function(){
