                                                ...
                                                <div class=" col-xs-12">
                                                    ...
                                                    <div class="form-group form-group-sm width-300px">
                                                     ...
                                                     <div class="form-group form-group-sm width-300px">
                                                        ...
                                                        <div class="col-sm-8  no-padding"  >
                                                            <input type="text" id="orgUuid" name="orgUuid" value="${dsm.orgUuid }" class="form-control input-small width-200px " data-placement="bottom" title=""   data-rel="tooltip" data-original-title="Hello Tooltip!">
                                                        </div>
                                                    </div>
                                                     <div class="form-group form-group-sm width-300px">
                                    ...
                                    <div class="widget-main no-padding ">
                                        <table class="table table-striped table-bordered table-hover dataTable no-footer DTTT_selectable">
                                            ...
                                            <tr>
                                                ...
                                                <th style="text-align: center;width: 13%">直属机构名称</th>
                                           ...
                                           <c:forEach items="${mecSumList}" var="de"  varStatus="status">
													<tr>
														...
														<td style="text-align: left;">${de.mecRegNm }</td>
    ...
    function uploadExcelMec(){
		...
		if(valiDt()){
			if(emptVali()){
				...
				alert("请加任一导出条件(商编、业务员编号、直属机构编号)");
			}
		}
    ...
    function queryMec(){
    	if(valiDt()){
    		if(emptVali()){
				...
				alert("请加任一查询条件(商编、业务员编号、直属机构编号)");
			}
    	}
    }
      ...
      function emptVali(){
    	  ...
    	  var orgUuid=$("#orgUuid").val().trim();
    	  if((mno==null ||mno=='') &&(empNo==null ||empNo=='')&&(orgUuid==null ||orgUuid=='') ){
    		 return false; 
    	  }
    	  return true;
      }
