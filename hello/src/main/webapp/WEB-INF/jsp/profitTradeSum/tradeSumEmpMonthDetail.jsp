                                              ...
                                              <tbody>
                                            	<c:forEach var="de" items="${empList}" varStatus="status">
                                            		<tr>
														...
														<td style="text-align: right;">${de.tradeSumDesc }</td>
														<td style="text-align: right;">${de.nocapAmountSumDesc }</td>
														<td style="text-align: right;">${de.feeSumDesc }</td>
														<td style="text-align: right;">${de.profitAmountDesc }</td>
														<td style="text-align: right;">${de.tradeCount }</td>
