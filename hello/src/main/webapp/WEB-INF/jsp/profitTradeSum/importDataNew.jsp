...
<body class="no-skin ">
                                	...
                                	<div class="widget-body">
	                                    <div class="widget-main no-padding ">
	                                        <div class="widget-main ">
	                                            <form class="form-inline form-horizontal" action="<%=request.getContextPath()%>/profitImportNew/importExcel.do" id="searchForm" method="post"  enctype="multipart/form-data">
	                                              	 <div class=" col-xs-12">
    ...
    <script type="text/javascript">
        ...
        function returnImportOrderPageb(){
        	location.href = '<%=request.getContextPath()%>/profitImportNew/showImportView.do';
        }
