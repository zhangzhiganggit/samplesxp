											...
											<tbody>
                                            	<c:forEach items="${goodsPriceList}" var="gp">
													...
													<tr class="tr-row">
														...
														<td>${gp.factName}</td>
														<td>${gp.modName}</td>
														<td style="border:1px solid #969696;display:none;" class="modId">${gp.modId}</td>
														<td style="border:1px solid #969696;display:none;" class="priceId">${gp.priceId}</td>
														<td>
														...
														<td>${gp.unit}</td>
														<td class="price" style="text-align:right;">${gp.price}</td>
													</tr>
													</c:if>
												</c:forEach>
                                            </tbody>
