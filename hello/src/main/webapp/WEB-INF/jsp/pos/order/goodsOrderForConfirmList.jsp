                                ...
                                <div class="widget-body">
                                    <div class="widget-main no-padding ">
                                        <div class="widget-main ">
                                            ...
                                            <form class="form-inline form-horizontal" action="<%=request.getContextPath() %>/posOrderAdmin/orderListForConfirmPage.do" id="searchForm">
                                                ...
                                                <div class=" col-xs-12">
                                                	<div class="form-group form-group-sm width-300px">
                                                        ...
                                                        <div class="col-sm-8  no-padding"  >
                                                            <input type="text" name="orgUuid" id="orgUuid" value="${goodsOrder.orgUuid }" class="form-control input-small width-200px" data-placement="bottom" title=""  data-rel="tooltip" data-original-title="Hello Tooltip!">
                                                        </div>
                                                    </div>
                                                    <div class="form-group form-group-sm width-300px">
                                                        <label for="form-field-6" class="col-sm-4 control-label widget-color-normal5 width-100px no-padding-left"  >订购单编号:</label>
                                                        <div class="col-sm-8  no-padding"  >
                                                            <input type="text" name="goodsOrderId" id="goodsOrderId" value="${goodsOrder.goodsOrderId }" class="form-control input-small width-200px" data-placement="bottom" title=""  data-rel="tooltip" data-original-title="Hello Tooltip!" onkeyup="this.value=this.value.replace(/[^+\d]/g,'')">
                                                        </div>
                                                    </div>
                                                    <div class="form-group form-group-sm width-300px">
                                ...
                                <div class="widget-body">
                                    <div class="widget-main no-padding ">
                                        <table class="table table-striped table-bordered table-hover dataTable no-footer DTTT_selectable">
                                            ...
                                            <tr>
                                                <th style="text-align:center;width:20%">订单编号 </th>
                                                <th style="text-align:center;width:20%">机构编号 </th>
                                                <th style="text-align:center;width:20%">代理商名称</th>
                                                <th style="text-align:center;width:10%">订货数量</th>
                                                <th style="text-align:center;width:20%">订单金额</th>
                                            ...
                                            <tbody>
                                             <c:forEach items="${goodsOrderlist}" var="goodsOrder" varStatus="status">
													<tr>
														...
														<td>${goodsOrder.orgUuid}</td>
														<td>${goodsOrder.orgNm}</td>
														<td style="text-align:center">${goodsOrder.totalQuantity}</td>
														<td style="text-align:center">${goodsOrder.paymentAmount}</td>
														<td>
															<a href="javascript:openIframe('${goodsOrder.goodsOrderId}',1)" class="blue">详情</a>
