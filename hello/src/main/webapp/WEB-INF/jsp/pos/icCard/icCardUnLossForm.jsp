                                ...
                                <div class="widget-body">
                                    <div class="widget-main no-padding ">
                                        <div class="widget-main ">
                                            <form class="form-inline form-horizontal" action="<%=request.getContextPath() %>/IcCardManage/updateCardRelieve" id="searchForm" method="post">
                                                ...
                                                <div class=" col-xs-12">
                                                   <div class="form-group form-group-sm width-300px">
                                                        ...
                                                        <div class="col-sm-8  no-padding"  >
															...
															<input type=text id="card_id" name="card_id" readonly value="${card.id }" class="form-control input-small width-200px   view-control"  />
                                                        </div>
                                                    </div>
                                                    <div class="form-group form-group-sm width-300px">
                                                ...
                                                <button type="button" class="btn btn-sm btn-danger saveBtn" name="save" id="saveButton"
														...
														<span class="ace-icon fa fa-floppy-o icon-on-right bigger-110"></span> 解冻
													</button>
