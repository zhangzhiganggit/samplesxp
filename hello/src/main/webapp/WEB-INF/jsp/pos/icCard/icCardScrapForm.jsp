                                ...
                                <div class="widget-body">
                                    <div class="widget-main no-padding ">
                                        <div class="widget-main ">
                                            <form class="form-inline form-horizontal" action="<%=request.getContextPath() %>/IcCardManage/updateCardScrap" id="searchForm" method="post">
                                                ...
                                                <button type="button" class="btn btn-sm btn-danger saveBtn" name="save" id="saveButton"
														...
														<span class="ace-icon fa fa-floppy-o icon-on-right bigger-110"></span> 作废
													</button>
