                                ...
                                <div class="widget-body">
                                    <div class="widget-main no-padding ">
                                        <div class="widget-main ">
                                            <form class="form-inline form-horizontal" action="<%=request.getContextPath() %>/IcCardManage/updateCardTakeback" id="searchForm" method="post">
                                                ...
                                                <div class=" col-xs-12">
                                                    ...
                                                    <div class="form-group form-group-sm width-300px" id="tel">
                                                        ...
                                                        <div class="col-sm-8  no-padding"  >
                                                           <input type=text id="telphone" name="telphone" readonly value="${card.telphone}" class="form-control input-small width-200px   view-control" />
                                                        </div>
                                                    </div>
                                                     <div class="form-group form-group-sm width-300px">
                                                    ...
                                                    <div class="form-group form-group-sm width-300px" >
                     								...
                     								<div class="form-group form-group-sm width-300px ">
                                                        <label class="col-sm-4 control-label widget-color-normal5 width-100px no-padding-left">冻结日期：</label>
                                                        <input type="text" hidden="hidden" id="xxx" value="2">
                                                        <div class="col-sm-8   no-padding">
                                                           <input type=text id="create_time" name="create_time" value="${card.lossDate}" class="form-control input-small width-200px   view-control" disabled='disabled'  >
                                                        </div>
                                                    </div>	
                                                    <div class="form-group form-group-sm width-300px ">
                                                ...
                                                <button type="button" class="btn btn-sm btn-danger saveBtn" name="save" id="saveButton"
														...
														<span class="ace-icon fa fa-floppy-o icon-on-right bigger-110"></span> 回收
													</button>
