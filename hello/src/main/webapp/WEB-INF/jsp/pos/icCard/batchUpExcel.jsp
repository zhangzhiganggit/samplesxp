...
<body class="no-skin ">
                                ...
                                <div class="widget-body">
                                    <div class="widget-main no-padding ">
                                        <div class="widget-main ">
											...
											<form class="form-inline form-horizontal" action="importBatchUpExcel" id="searchForm" method="post"  enctype="multipart/form-data" onsubmit="return dosubmit()">
													<div class=" col-xs-12">
    ...
    function exportDown(){
		location.href='<%=request.getContextPath()%>/SimCard/excelDown'
	}
