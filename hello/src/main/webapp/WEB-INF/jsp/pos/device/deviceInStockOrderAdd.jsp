...
function save()
{
	...
	var remarkURI = window.encodeURI(window.encodeURI(remark));   
	...
	if(remark.length>50){
		alert("备注信息字数不能超过50字符")
		$("#remark").focus();
		return;
	}
	$.ajax({
		type : "GET",
		url : "${ctx}/device/deviceInStockOrder/add?mod_id="+mod_id+
		"&goods_id="+goods_id+
		"&fact_id="+fact_id+
		"&sn_prefix="+sn_prefix+
		"&sn_suffix="+sn_suffix+
							...
							<div class="widget-box widget-color-normal3" style="opacity: 1;">
								<div class="widget-header">
									<h5 class="widget-title bigger lighter">
										<i class="ace-icon fa fa-table"></i> 新增设备附件入库单草稿（不含sim卡）
									</h5>
								</div>
										...
										<div class="widget-main ">
											<form id="submitForm" action=""
												...
												<div class=" col-xs-12">
													...
													<div class="form-group form-group-sm width-300px">
														<label
															class="col-sm-4 control-label  widget-color-normal5 width-100px no-padding-left">起序列号<span
															class="red">*</span>:
														</label>
														<div class="col-sm-8  no-padding">
															<input type="text" name="sn_begin"
																id="sn_begin" value="${org.contact }" 
																class="form-control input-small width-200px "
																data-placement="bottom" title="不能超过18个数字">
														</div>
													</div>
													<div class="form-group form-group-sm width-300px no-padding">
														<label
															class="col-sm-4 control-label  widget-color-normal5 width-100px no-padding ">终序列号<span
															class="red">*</span>:
														</label>
														<div class="col-sm-8 no-padding">
															<input type="text" class="form-control width-200px"
																value="${org.contactTelNo }" 
													...
													<div class="form-group form-group-sm  width-300px">
														<label class="col-sm-4 control-label  widget-color-normal5 width-100px">前缀:</label>
														<div class="col-sm-8  no-padding">
													...
													<div class="form-group form-group-sm width-200px ">
														<label class="col-sm-7 control-label  widget-color-normal5 width-150px ">是否携机入网:</label>
														<div class="col-sm-2 no-padding">
															<input type="checkbox" class="form-control input-small width-20px " size="1"
																value="0"  <c:if test="${deviceInStockOrder.merc_own==1}"> checked </c:if>
																name="merc_own" id="merc_own" data-placement="bottom">
														</div>
													</div>
													<div class="form-group form-group-sm width-200px " id="existnoncontact">
														<label class="col-sm-7 control-label  widget-color-normal5 width-120px ">是否支持非接:</label>
														<div class="col-sm-2 no-padding">
															<input type="checkbox" class="form-control input-small width-20px " size="1"
													...
													<div class="form-group form-group-sm width-320px ">
														<label class="col-sm-7 control-label  widget-color-normal5 width-120px ">当前系统版本:</label>
														<div class="col-sm-2 no-padding">
															<input type="text" class="form-control input-small width-200px "
																  id="currentSysVersion" name="currentSysVersion" 
																readonly value="1.8.35.2537" class="form-control input-sm"  data-placement="bottom">
														</div>
													</div>
													</br>
													<div class="form-group form-group-sm width-1200px ">
														<label class="col-sm-3 control-label  widget-color-normal5 width-100px ">备注:</label>
														<div class="col-sm-8 no-padding">
															  <textarea id="remark" name="remark" style="height:60px;width: 850px;" value=""
															   class="form-control limited input-small width-850"></textarea>
														</div>
													</div> 
												</div>
												</br>
