...
<script type="text/javascript">
		function processing(){
			...
			if(executerNm==null || executerNm=='' ||executerNm.length>30){
				alert("处理人信息为1-30个字符");
				return;
			}
												...
												<div class=" col-xs-12">
													<div class="form-group form-group-sm  width-300px">
														...
														<div class="col-sm-8  no-padding">
															<input id="executerNm" name="executerNm"
																class="form-control input-small width-200px   view-control  "
																value="${empNm }" data-content="" data-placement="bottom"
