...
<component:portlet>
    ...
    <portlet:body withForm="true">
        ...
        <formCommon:hiddenField name="hiddenMecNormalLevelFinal" id="hiddenMecNormalLevelFinal" value="${merchantIncomeModifyInstance?.mecNormalLevel}"/>
            <input type="hidden" name="tipsOperateNum" id="tipsOperateNum" value="${tipsOperateNum}"/>
            <input type="hidden" name="tipsInfo" id="tipsInfo" value="${merchantIncomeModifyInstance?.tipsInfo}"/>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group-sm">
                                    <label class="col-sm-5 control-label">
                                        %{--商户编号--}%
                                        <span class="required"></span><message:property domain="merchantIncomeModify" property="merchantCode"/>:
                                    </label>
                                    <div class="col-sm-7">
                            ...
                            <div class="col-md-4">
                                <div class="form-group-sm">
                                    <label class="col-sm-5 control-label">
                                        %{--商户类型--}%
                                        <span class="required">*</span><message:property domain="merchantIncomeModify" property="merchantType"/>:
                                    </label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group-sm">
                                    <label class="col-sm-5 control-label">
                                        %{--特殊商户--}%
                                        <span class="required">*</span><message:property domain="merchantIncomeModify" property="specialMerchant"/>:
                                    </label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group-sm">
                                    <label class="col-sm-5 control-label">
                                        ...
                                        <span class="required">*</span><message:property domain="merchantIncomeModify" property="branchShopSet"/>:
                        ...
                        <div id="subjectionDiv" class="hidden row">
                            <div class="col-md-4">
                                <div class="form-group-sm">
                                    <label class="col-sm-5 control-label">
                                        %{--隶属商户编号--}%
                                        <span class="required">*</span><message:property domain="merchantIncomeModify" property="subjectionMerchantCode"/>:
                                    </label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group-sm">
                                    <label class="col-sm-5 control-label">
                                        %{--隶属商户名称--}%
                                        <span class="required">*</span><message:property domain="merchantIncomeModify" property="subjectionMerchantName"/>:
                                    </label>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group-sm">
                                    <label class="col-sm-5 control-label">
                                        %{--经营名称--}%
                                        <span class="required">*</span><message:property domain="merchantIncomeModify" property="businessName"/>:
                                    </label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group-sm">
                                    <label class="col-sm-5 control-label">
                                        %{--签购单名称--}%
                                        <span class="required">*</span><message:property domain="merchantIncomeModify" property="receiptsName"/>:
                                    </label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group-sm">
                                    <label class="col-sm-5 control-label">
                                        %{--经营范围：--}%
                                        <span class="required">*</span><message:property domain="merchantIncomeModify" property="businessScope"/>:
                                    </label>
                    ...
                    %{--商户等级--}%
                        ...
                        <div class="row" style="margin-bottom: 0.5rem;">
                            <div class="col-md-10">
                                ...
                                <div class="form-group-sm">
                                    <label class="col-sm-2 control-label">
                                        <span class="required">*</span><message:property domain="merchantIncomeModify" property="bindAddressProvince"/>:
                                    </label>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group-sm">
                                    <label class="col-sm-5 control-label">
                                        %{--营业地址=装机地址街道--}%
                                        <span class="required">*</span><message:property domain="merchantIncomeModify" property="bindAddressStreet"/>:
                                    </label>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                 <div class="form-group-sm">
                                     <label class="col-sm-5 control-label">
                                         %{--营业时间--}%
                                         <span class="required">*</span><message:property domain="merchantIncomeModify" property="businessStartTime"/>:
                                     </label>
                                     <div class="col-sm-7">
                                         <div class="input-group ">
                            ...
                            <div class="col-md-4">
                                <div class="form-group-sm">
                                    <label class="col-sm-5 control-label">
                                        %{--用地面积：--}%
                                        <span class="required">*</span><message:property domain="merchantIncomeModify" property="siteArea"/>:
                                    </label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group-sm">
                                    <label class="col-sm-5 control-label">
                                        %{--联系人姓名：--}%
                                        <span class="required">*</span><message:property domain="merchantIncomeModify" property="linkmanName"/>:
                                    </label>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group-sm">
                                    <label class="col-sm-5 control-label">
                                        %{--联系人手机号：--}%
                                        <span class="required">*</span><message:property domain="merchantIncomeModify" property="linkmanMobileNo"/>:
                                    </label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group-sm">
                                    <label class="col-sm-5 control-label">
                                        %{--客服电话：--}%
                                        <span class="required">*</span><message:property domain="merchantIncomeModify" property="serviceTel"/>:
                                    </label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group-sm">
                                    <label class="col-sm-5 control-label">
                                        %{--管理员手机号：--}%
                                        <span class="required">*</span><message:property domain="merchantIncomeModify" property="managerPhone"/>:
                                    </label>
                        ...
                        <div class="row">
                             <div class="col-md-4">
                                <div class="form-group-sm">
                                    <label class="col-sm-5 control-label">
                                        %{--拓展类型--}%
                                        <span class="required">*</span><message:property domain="merchantIncomeModify" property="expandType"/>:
                                    </label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group-sm">
                                    <label class="col-sm-5 control-label">
                                        %{--商户类别：--}%
                                        <span class="required">*</span><message:property domain="merchantIncomeModify" property="merchantClassify"/>:
                                        <input type="hidden" id="merchantClassify" name="merchantClassify" value="${merchantIncomeModifyInstance?.merchantClassify}"/>
                                    </label>

                                    <div class="col-sm-7">
                                        <g:textField readonly="true" class="form-control" name="merchantClassifyShow" id="merchantClassifyShow" value=""/>
                            ...
                            <div class="col-md-4">
                                <div class="form-group-sm">
                                    <label class="col-sm-5 control-label">
                                        %{--归属机构：--}%
                                        <message:property domain="merchantIncomeModify" property="belongToOrg"/>:
                                    </label>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group-sm">
                                    <label class="col-sm-5 control-label">
                                    %{--业务员名称--}%
                                        <span class="required">*</span><message:property domain="merchantIncomeModify" property="salesmanName"/>:
                                    </label>
                             ...
                             <div class="col-md-4">
                                 <div class="form-group-sm">
                                     <label class="col-sm-5 control-label">
                                         %{--业务员编号：--}%
                                         <span class="required">*</span><message:property domain="merchantIncomeModify" property="salesmanCode"/>:
                                     </label>
                             ...
                             <div class="col-md-4">
                                 <div class="form-group-sm">
                                     <label class="col-sm-5 control-label">
                                         %{--行业大类--}%
                                         <span class="required">*</span><message:property domain="merchantIncomeModify" property="businessClassify"/>:
                                     </label>

                                     <div class="col-sm-7">
                                         <g:select style="margin-bottom: 0.5rem;" class="form-control" name="businessClassify" disabled="true"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group-sm">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="input-group">
                                            <g:textField readonly="true" class="form-control" name="customClassifyText" id="customClassifyText" value="${merchantIncomeModifyInstance?.customClassifyText}"/>
                        ...
                        <div id="bt1" class="hidden row">
                            <div class="col-md-4">
                                <div class="form-group-sm">
                                    <label class="col-sm-5 control-label">
                                        %{--所在银行--}%
                                        <span class="required">*</span><message:property domain="merchantIncomeModify" property="customerManagerBank"/>:
                            ...
                            <div class="col-md-4">
                                <div class="form-group-sm">
                                    <label class="col-sm-5 control-label">
                                        %{--合作经理--}%
                                        <span class="required">*</span><message:property domain="merchantIncomeModify" property="customerManager"/>:
                                    </label>
                        ...
                        <div id="bt2" class="hidden row">
                            <div class="col-md-4">
                                <div class="form-group-sm">
                                    <label class="col-sm-5 control-label">
                                        %{--银行合作标识--}%
                                        <span class="required">*</span><message:property domain="merchantIncomeModify" property="bankTeamworkSign"/>:
                                    </label>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group-sm">
                                    <label class="col-sm-5 control-label">
                                        %{--预设行业大类--}%
                                        <span  class="required">*</span><message:property domain="merchantIncomeModify" property="preBusinessClassify"/>:
                                    </label>
                                    <div class="col-sm-7">
                                        <g:select style="margin-bottom: 0.5rem;" class="form-control" name="preBusinessClassify" id="preBusinessClassify"
                                                  from="${MerchantIncomeModify.getConstraintsMap()['preBusinessClassify'].inList}"
                                                  value="${merchantIncomeModifyInstance ? merchantIncomeModifyInstance['preBusinessClassify'] : ''}"
                                                  noSelection="['': '请选择']"
                                                  valueMessagePrefix="merchantIncomeModify.preBusinessClassify"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <portlet:body withForm="false">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group-sm">
                                                <label class="col-sm-3 control-label">
                                                    %{--注册名称：--}%
                                                    <span  class="required">*</span><message:property domain="merchantIncomeModify"  property="registName"/>:
                                                </label>
                                    ...
                                    <div class="row" style="margin-bottom: 0.5rem;">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group-sm">
                                                <label class="col-sm-3 control-label">
                                                    <span class="required">*</span><message:property domain="merchantIncomeModify" property="registAddressProvince"/>:
                                                </label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group-sm">
                                                <label class="col-sm-2 control-label">
                                                    %{--注册地址街道--}%
                                                    <span class="required">*</span><message:property domain="merchantIncomeModify" property="registAddressStreet"/>:
                                                </label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group-sm">
                                                <label class="col-sm-3 control-label">
                                                    %{--注册登记号--}%
                                                    <span class="required">*</span><message:property domain="merchantIncomeModify" property="registCode"/>:
                                                </label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group-sm">
                                                <label class="col-sm-3 control-label">
                                                    %{--法人姓名--}%
                                                    <span class="required" id="legalPersonName_red">*</span><message:property domain="merchantIncomeModify" property="legalPersonName"/>:
                                                </label>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group-sm">
                                                <label class="col-sm-5 control-label">
                                                    %{--法人证件类型--}%
                                                    <span class="required" id="legalPersonLicenseType_red" style="display: none">*</span><message:property domain="merchantIncomeModify" property="legalPersonLicenseType"/>:
                                                </label>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group-sm">
                                                <label class="col-sm-3 control-label">
                                                    %{--法人证件号--}%
                                                    <span class="required" id="legalPersonCode_red" style="display: none">*</span><message:property domain="merchantIncomeModify" property="legalPersonCode"/>:
                                                </label>
                                    ...
                                    <div class="form-group-sm">
                                        ...
                                        <div class="col-sm-7 ${hasErrors(bean: merchantIncomeModifyInstance, field: 'businessName', ' takin-input-errors')}">
                                            <g:select style="margin-bottom: 0.5rem;" class="form-control" name="settleAccountType1" id="settleAccountType1"
                                                      ...
                                                      value="${merchantIncomeModifyInstance?.defaultSettle=='1'?(merchantIncomeModifyInstance ? merchantIncomeModifyInstance['settleAccountType2'] : ''):(merchantIncomeModifyInstance ? merchantIncomeModifyInstance['settleAccountType1'] : '')}"
					...
					%{--银行详细信息--}%
                                        ...
                                        <div class="col-sm-7 ${hasErrors(bean: merchantIncomeModifyInstance, field: 'toPrivateOpenbankInfomation', ' takin-input-errors')}">
                                            <tk:autoComplete class="form-control input-xlarge takin-autoComplete"
                                                             ...
                                                             value="${merchantIncomeModifyInstance?.defaultSettle=='1'?(merchantIncomeModifyInstance?.toPublicOpenbankInfomation):(merchantIncomeModifyInstance?.toPrivateOpenbankInfomation)}"/>
                                            <span class="help-block"><g:fieldError bean="${merchantIncomeModifyInstance}"  field="toPrivateOpenbankInfomation"/></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group-sm">
                                        ...
                                        <div class="col-sm-7 ${hasErrors(bean: merchantIncomeModifyInstance, field: 'toPrivateCnapsCode', ' takin-input-errors')}">
                                            <g:textField class="form-control" name="toPrivateCnapsCode" id="toPrivateCnapsCode" readonly="readonly" value="${merchantIncomeModifyInstance?.defaultSettle=='1'?(merchantIncomeModifyInstance?.toPublicCnapsCode):(merchantIncomeModifyInstance?.toPrivateCnapsCode)}"/>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group-sm">
                                        ...
                                        <div class="col-sm-7 ${hasErrors(bean: merchantIncomeModifyInstance, field: 'toPrivateAccountName', ' takin-input-errors')}">
                                            <g:textField class="form-control" name="toPrivateAccountName" id="toPrivateAccountName" value="${merchantIncomeModifyInstance?.defaultSettle=='1'?(merchantIncomeModifyInstance?.toPublicAccountName):(merchantIncomeModifyInstance?.toPrivateAccountName)}"/>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group-sm">
                                        ...
                                        <div class="col-sm-7 ${hasErrors(bean: merchantIncomeModifyInstance, field: 'toPrivateSettleAccountNo', ' takin-input-errors')}">
                                            <g:textField class="form-control" name="toPrivateSettleAccountNo" id="toPrivateSettleAccountNo" value="${merchantIncomeModifyInstance?.defaultSettle=='1'?(merchantIncomeModifyInstance?.toPublicSettleAccountNo):(merchantIncomeModifyInstance?.toPrivateSettleAccountNo)}"/>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group-sm">
                                        ...
                                        <div class="col-sm-7 ${hasErrors(bean: merchantIncomeModifyInstance, field: 'toPrivateSettleAccountNoTwo', ' takin-input-errors')}">
                                            <g:textField class="form-control" name="toPrivateSettleAccountNoTwo" id="toPrivateSettleAccountNoTwo" value="${merchantIncomeModifyInstance?.defaultSettle=='1'?(merchantIncomeModifyInstance?.toPublicSettleAccountNoTwo):(merchantIncomeModifyInstance?.toPrivateSettleAccountNoTwo)}"/>
                                    ...
                                    <div class="form-group-sm">
                                        ...
                                        <div class="col-sm-7 ${hasErrors(bean: merchantIncomeModifyInstance, field: 'settleManidNumber', ' takin-input-errors')}">
                                            <g:textField class="form-control" name="settleManidNumber" id="settleManidNumber"
                                                         value="${merchantIncomeModifyInstance?.defaultSettle=='1'?(merchantIncomeModifyInstance?.settleManidNumber2):(merchantIncomeModifyInstance?.settleManidNumber)}"/>
                                ...
                                <div id="accountLegalNmDiv" class="col-md-4">
                                    <div class="form-group-sm">
                                        <label class="col-sm-5 control-label">
                                            ...
                                            <span  class="required">*</span>账户法人姓名:
                                        </label>
                                        ...
                                        <div class="form-group-sm">
                                            ...
                                            <div class="col-sm-7 ${hasErrors(bean: merchantIncomeModifyInstance, field: 'businessName', ' takin-input-errors')}">
                                                <g:select style="margin-bottom: 0.5rem;" class="form-control" name="settleAccountType2" id="settleAccountType2"
                                                          ...
                                                          value="${merchantIncomeModifyInstance?.defaultSettle=='1'?(merchantIncomeModifyInstance ? merchantIncomeModifyInstance['settleAccountType1'] : ''):(merchantIncomeModifyInstance ? merchantIncomeModifyInstance['settleAccountType2'] : '')}"
                                        ...
                                        <div class="form-group-sm">
                                            ...
                                            <div class="col-sm-7 ${hasErrors(bean: merchantIncomeModifyInstance, field: 'toPublicOpenbankInfomation', ' takin-input-errors')}">
                                                <tk:autoComplete class="form-control input-xlarge takin-autoComplete"
                                                                 ...
                                                                 linkParams="[controller: 'merchantIncome', action: 'autoComplete']"
                                                                 value="${merchantIncomeModifyInstance?.defaultSettle=='1'?(merchantIncomeModifyInstance?.toPrivateOpenbankInfomation):(merchantIncomeModifyInstance?.toPublicOpenbankInfomation)}"/>
                                                <span class="help-block"><g:fieldError bean="${merchantIncomeModifyInstance}" field="toPublicOpenbankInfomation"/></span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group-sm">
                                            ...
                                            <div class="col-sm-7 ${hasErrors(bean: merchantIncomeModifyInstance, field: 'toPublicCnapsCode', ' takin-input-errors')}">
                                                <g:textField class="form-control" name="toPublicCnapsCode" id="toPublicCnapsCode" readonly="readonly" value="${merchantIncomeModifyInstance?.defaultSettle=='1'?(merchantIncomeModifyInstance?.toPrivateCnapsCode):(merchantIncomeModifyInstance?.toPublicCnapsCode)}"/>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group-sm">
                                            ...
                                            <div class="col-sm-7 ${hasErrors(bean: merchantIncomeModifyInstance, field: 'toPublicAccountName', ' takin-input-errors')}">
                                                <g:textField class="form-control" name="toPublicAccountName" id="toPublicAccountName" value="${merchantIncomeModifyInstance?.defaultSettle=='1'?(merchantIncomeModifyInstance?.toPrivateAccountName):(merchantIncomeModifyInstance?.toPublicAccountName)}"/>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group-sm">
                                            ...
                                            <div class="col-sm-7 ${hasErrors(bean: merchantIncomeModifyInstance, field: 'toPublicSettleAccountNo', ' takin-input-errors')}">
                                                <g:textField class="form-control" name="toPublicSettleAccountNo" id="toPublicSettleAccountNo" value="${merchantIncomeModifyInstance?.defaultSettle=='1'?(merchantIncomeModifyInstance?.toPrivateSettleAccountNo):(merchantIncomeModifyInstance?.toPublicSettleAccountNo)}"/>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group-sm">
                                            ...
                                            <div class="col-sm-7 ${hasErrors(bean: merchantIncomeModifyInstance, field: 'toPublicSettleAccountNoTwo', ' takin-input-errors')}">
                                                <g:textField class="form-control" name="toPublicSettleAccountNoTwo" id="toPublicSettleAccountNoTwo" value="${merchantIncomeModifyInstance?.defaultSettle=='1'?(merchantIncomeModifyInstance?.toPrivateSettleAccountNoTwo):(merchantIncomeModifyInstance?.toPublicSettleAccountNoTwo)}"/>
                                        ...
                                        <div class="form-group-sm">
                                            ...
                                            <div class="col-sm-7 ${hasErrors(bean: merchantIncomeModifyInstance, field: 'settleManidNumber2', ' takin-input-errors')}">
                                                <g:textField class="form-control" name="settleManidNumber2" id="settleManidNumber2"
                                                             value="${merchantIncomeModifyInstance?.defaultSettle=='1'?(merchantIncomeModifyInstance?.settleManidNumber):(merchantIncomeModifyInstance?.settleManidNumber2)}"/>
                                ...
                                <div class="col-md-1">
                                    <div class="form-group">
                                        <label class="col-md-12 control-label">
                                            ...
                                            <span class="required">*</span><message:property domain="merchantIncomeModify" property="functionAcceptanceSettle"/>:
                                ...
                                <div class="col-sm-3">
                                    <div class="fileinput fileinput-new" data-provides="fileinput" title="营业执照">
                                        ...
                                        <div>
                                            ...
                                            <a href="javascript:;" class="btn red fileinput-exists" data-dismiss="fileinput"><message:property  domain="merchantIncomeModify" property="deltePic"/></a>
                                        </div>
...
<content tag="takin-footer">
    ...
    <asset:javascript src="merchantIncome/modify/merchantIncomeModify.js"/>
    <asset:javascript src="merchantIncome/modify/form-validation.js"/>
