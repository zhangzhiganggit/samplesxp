<%@ page import="com.suixingpay.ssp.front.merchant.merchantIncome.MerchantIncome; com.suixingpay.ssp.front.merchant.merchantIncome.MerchantIncomeModify" %>
<style>
#tip {
    position: absolute;
    top: 20%;
...
<component:portlet>
    ...
    <portlet:body withForm="true">
        ...
        <!--创建人-->
            <formCommon:hiddenField name="merchantMcc" id="merchantMccId" value="${merchantIncomeModifyInstance?.createUserId}"/><!--创建人-->
            <formCommon:hiddenField name="merchantMcc" id="merchantMccId" value="${merchantIncomeModifyInstance?.createUserId}"/>
            ...
            <formCommon:hiddenField name="ifZft" id="ifZft" />
            <formCommon:hiddenField name="hideCustomerManagerBank" id="hideCustomerManagerBank" />
            <formCommon:hiddenField name="hideCustomerManager" id="hideCustomerManager" />
            <formCommon:hiddenField name="intradayPayCounterFee" id="intradayPayCounterFee" />
            <formCommon:hiddenField name="ifOtherConsumption" id="ifOtherConsumption" />
        %{--商户等级--}%
        ...
        %{-- <formCommon:hiddenField name="tipsInfo" id="tipsInfo" value="${merchantIncomeModifyInstance?.tipsInfo}"/>--}%
                ...
                <component:portlet>
                                ...
                                <div class="form-group-sm">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="input-group">
                                            <g:textField class="form-control" name="merchantCode" value="${merchantIncomeModifyInstance?.merchantCode}"/>
                                            <span class="input-group-btn">
                                                <a id="findMerchantInfo" class="btn btn-primary" data-toggle="modal" style="padding: 0.51rem;margin-top: 0rem;">
                                                    <i class="fa">查询</i>
                                                </a>
                                            </span>
                                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group-sm">
                                    ...
                                    <div class="col-sm-7 ${hasErrors(bean: merchantIncomeModifyInstance, field: 'businessName', ' takin-input-errors')}">
                                        <g:textField class="form-control" name="businessName" value="${merchantIncomeModifyInstance?.businessName}" readonly="readonly" onmouseover="this.title=this.value"/>
                    ...
                    %{--商户等级--}%
                        ...
                        <span class="required">*</span><message:property domain="merchantIncomeModify" property="expandType"/>:
                                    ...
                                    <div class="col-sm-7">
                                        <g:select style="margin-bottom: 0.5rem;" class="form-control" name="expandType"
                            ...
                            <div class="col-md-4">
                                <div class="form-group-sm">
                                    ...
                                    <div class="col-sm-7 ${hasErrors(bean: merchantIncomeModifyInstance, field: 'salesmanName', ' takin-input-errors')}">
                                        <g:textField class="form-control" name="salesmanName" value="${merchantIncomeModifyInstance?.salesmanName}"  readonly="readonly"/>
                             ...
                             <div class="col-md-4">
                                 <div class="form-group-sm">
                                     <label class="col-sm-5 control-label">
                                         %{--业务员编号：--}%
                                         <message:property domain="merchantIncomeModify" property="salesmanCode"/>:
                                     </label>
                                ...
                                <div class="form-group-sm">
                                    ...
                                    <div class="col-sm-7">
                                        <g:select style="margin-bottom: 0.5rem;" class="form-control" name="customerManagerBank" id="customerManagerBank"
                                                  ...
                                                  value="${params ? params['customerManagerBank'] : ''}"
                            ...
                            <div class="col-md-4">
                                <div class="form-group-sm">
                                    ...
                                    <div class="col-sm-7 ${hasErrors(bean: merchantIncomeModifyInstance, field: 'bankTeamworkSign', ' takin-input-errors')}">
                                        <div class="input-group">
                                            <g:textField readonly="true" class="form-control" name="bankTeamworkSignText" value=""/>
                                            <formCommon:hiddenField name="bankTeamworkSign" id="bankTeamworkSign" value="${merchantIncomeModifyInstance?.customClassify}"/>
                                            <div class="input-group-btn input-group-sm">
                                ...
                                <div class="form-group-sm">
                                    ...
                                    <div class="col-sm-7">
                                        <g:select style="margin-bottom: 0.5rem;" class="form-control" name="preBusinessClassify" id="preBusinessClassify"
                                                  ...
                                                  value="${merchantIncomeModifyInstance ? merchantIncomeModifyInstance['businessClassify'] : ''}"
                                                  valueMessagePrefix="merchantIncomeModify.businessClassify" noSelection="['': '请选择']"/>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            %{--其他信息 Portlet--}%
                <div class="tabbable-custom">
                                    ...
                                    <div class="row" style="margin-bottom: 0.5rem;">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group-sm">
                                                ...
                                                <div class="col-sm-9 ${hasErrors(bean: merchantIncomeModifyInstance, field: 'registAddressStreet', ' takin-input-errors')}">
                                ...
                                <div class="col-md-10 col-md-offset-1">
                                    <div class="form-group-sm col-sm-6">
                                        ...
                                        <div class="col-sm-5 ${hasErrors(bean: merchantIncomeModifyInstance, field: 'intradayPayCounterFee', ' takin-input-errors')}">
                                            <g:textField class="form-control" name="intradayPayCounterFeeText"
					...
					%{--银行详细信息--}%
                                        ...
                                        <div hidden class="col-sm-7 ${hasErrors(bean: merchantIncomeModifyInstance, field: 'toPrivateOpenbankInfomationOld', ' takin-input-errors')}">
                                            <tk:autoComplete class="form-control input-xlarge takin-autoComplete"
                                                             name="toPrivateOpenbankInfomationOld" id="toPrivateOpenbankInfomationOld"
                                                             linkParams="[controller: 'merchantIncome', action: 'autoComplete']"
                                                             value="${merchantIncomeModifyInstance?.toPrivateOpenbankInfomation}"/>
                                            <span class="help-block"><g:fieldError bean="${merchantIncomeModifyInstance}"  field="toPrivateOpenbankInfomationOld"/></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div id="settleCard1-line2" class="row">
                                <div class="col-md-4">
                                    <div class="form-group-sm">
                                        ...
                                        <div hidden class="col-sm-7 ${hasErrors(bean: merchantIncomeModifyInstance, field: 'toPrivateCnapsCodeOld', ' takin-input-errors')}">
                                            <g:textField class="form-control" name="toPrivateCnapsCodeOld" id="toPrivateCnapsCodeOld" readonly="readonly" value="${merchantIncomeModifyInstance?.toPrivateCnapsCode}"/>
                                            <span class="help-block"><g:fieldError bean="${merchantIncomeModifyInstance}" field="toPrivateCnapsCodeOld"/></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group-sm">
                                        ...
                                        <div class="col-sm-7 ${hasErrors(bean: merchantIncomeModifyInstance, field: 'toPrivateAccountName', ' takin-input-errors')}">
                                            <g:textField class="accountName form-control" name="toPrivateAccountName" id="toPrivateAccountName" value="${merchantIncomeModifyInstance?.toPrivateAccountName}"/>
                            ...
                            <div id="settleCard2Info" hidden="hidden">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group-sm">
                                            ...
                                            <div class="col-sm-7 ${hasErrors(bean: merchantIncomeModifyInstance, field: 'toPublicAccountName', ' takin-input-errors')}">
                                                <g:textField class="accountName form-control" name="toPublicAccountName" id="toPublicAccountName" value="${merchantIncomeModifyInstance?.toPublicAccountName}"/>
                                ...
                                <div id="settleCard2-line3" class="row">
                                    ...
                                    <div class="col-md-4" id="settleManidNumber2Div" hidden>
                                        <div class="form-group-sm">
                                            <label class="col-sm-5 control-label">
                                                %{--结算人身份证号2--}%
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="fileinput fileinput-new" data-provides="fileinput" title="法人身份证正面">
                                        <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                            %{--<div style="margin-top: 30%;color: #2a4d6c">法人身份证正面</div>--}%
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="fileinput fileinput-new" data-provides="fileinput" title="法人身份证反面">
                                        <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                            %{--<div style="margin-top: 30%;color: #2a4d6c">法人身份证反面</div>--}%
...
<content tag="takin-footer">
    ...
    $(function(){
        ...
        $("input").not($(".accountName") ).keyup(function(){this.value=this.value.replace(/\s/g,'')});
