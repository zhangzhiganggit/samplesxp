...
<component:portlet cssClass="scaffold-searchResult">
    ...
    <portlet:body withForm="true">
        <g:form useToken="true" controller="merchantSmallAndMicroModify" id="scaffold-update-merchantSmallAndMicroModify" enctype="multipart/form-data" class="form-horizontal"
            ...
            <formCommon:hiddenField name="uid" value="${merchantSmallAndMicroModifyInstance?.uid}"/>
            <!--装机地址->省市区使用-->
                                ...
                                <div class="form-group-sm form-sm-checkboxes">
                                    <div class="md-checkbox-inline"><div class="md-checkbox">
                                        <g:checkBox name="huanLeZu" id="ifHuanLeZu"
                                                    value="${merchantSmallAndMicroModifyInstance ? merchantSmallAndMicroModifyInstance['huanLeZu'] : ''}"
                                                    readonly="readonly"
                                                    class="md-check"/>
                                        <label for="huanLeZu" class="small">
                                            <span class="inc"></span>
                                            <span class="check"></span>
                                            <span class="box"></span> <message:property domain="merchantSmallAndMicroModify"
                                                                                        property="huanLeZu"/>
                                        </label>
                                        <span class="small"><message:property domain="merchantSmallAndMicroModify"
