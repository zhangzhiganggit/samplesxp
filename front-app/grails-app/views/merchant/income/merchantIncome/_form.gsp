...
<component:portlet>
    ...
    <portlet:body withForm="true">
        ...
        %{--<formCommon:hiddenField name="_method" value="PUT" jkjjid="_method"/>--}%
        %{--<!--主键用于更新-->--}%
        ...
        %{--设置隐藏域--}%
            ...
            <formCommon:hiddenField name="ifDraft" value="0"/>
            %{--商户等级判断结算信息对公，对私--}%
           ...
           %{--posMd费率信息--}%
                            ...
                            <div class="col-md-4">
                                <div class="form-group-sm">
                                    ...
                                    <div class="col-sm-7 ${hasErrors(bean: merchantIncomeInstance, field: 'salesmanName', ' takin-input-errors')}">
                                        ...
                                        <span class="help-block"><g:fieldError bean="${merchantIncomeInstance}" field="salesmanCode"/></span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group-sm">
                                    ...
                                    <div class="col-sm-7 ${hasErrors(bean: merchantIncomeInstance, field: 'bankTeamworkSign', ' takin-input-errors')}">
                                        <div class="input-group">
                                            ...
                                            <formCommon:hiddenField name="bankTeamworkSign" id="bankTeamworkSign" value="${merchantIncomeInstance?.customClassify}"/>
                                            <div class="input-group-btn input-group-sm">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group-sm">
                                    <label class="col-sm-5 control-label">
                                        %{--(个体)开户行信息--}%
                                        <i class="fa fa-question-circle show-pop" data-popover-message="请使用关键词检索，关键词间用空格隔开，例如：北京  石景山  工商"></i>
                                ...
                                <div class="tab-pane" id="tab_5_2">
                                    <div class="row">
                                        <div class="col-sm-3" ondrop="drop(event)" ondragover="allowDrop(event)">
                                            <div class="fileinput fileinput-new" data-provides="fileinput" title="营业执照">
                                                <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                    ...
                                                    <div style="margin-top: 30%;color: #2a4d6c">
                                                    <p style="color: #ff0000;">＊营业执照</p>
                                                    <p class="badge badge-danger">1</p>
                                                </div>
                                                </div>
                                        ...
                                        <div class="col-sm-3" ondrop="drop(event)" ondragover="allowDrop(event)">
                                            <div class="fileinput fileinput-new" data-provides="fileinput" title="税务登记证">
                                                <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                    <p style="margin-top: 30%;color: #2a4d6c">税务登记证</p>
                                                    <p class="badge badge-success">2</p>
                                                </div>
                                        ...
                                        <div class="col-sm-3" ondrop="drop(event)" ondragover="allowDrop(event)">
                                            <div class="fileinput fileinput-new" data-provides="fileinput" title="组织机构代码证">
                                                <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;margin-bottom: 3%">
                                                    <p style="margin-top: 30%;color: #2a4d6c">组织机构代码证</p>
                                                    <p class="badge badge-success">3</p>
                                                </div>
                                        ...
                                        <div class="col-sm-3" ondrop="drop(event)" ondragover="allowDrop(event)">
                                            <div class="fileinput fileinput-new" data-provides="fileinput" title="法人身份证正面">
                                                <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                    <div style="margin-top: 30%;color: #2a4d6c;"><p>
                                                        <span style="color: #ff0000;display: none" id="legalPersonidPositivePic_red">＊</span>法人身份证正面</p>
                                                        <p class="badge badge-success">4</p>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3" ondrop="drop(event)" ondragover="allowDrop(event)">
                                            <div class="fileinput fileinput-new" data-provides="fileinput" title="法人身份证反面">
                                                <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                    <div style="margin-top: 30%;color: #2a4d6c"><p><span style="color: #ff0000;display: none" id="legalPersonidOppositePic_red">＊</span>法人身份证反面</p>
                                                        <p class="badge badge-success">5</p>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-sm-3" ondrop="drop(event)" ondragover="allowDrop(event)">
                                            <div class="fileinput fileinput-new" data-provides="fileinput" title="结算人身份证正面">
                                                <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                    <div style="margin-top: 30%;color: #2a4d6c"><p style="color: #ff0000;">＊结算人身份证正面</p>
                                                        <p class="badge badge-danger">6</p>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-sm-3" ondrop="drop(event)" ondragover="allowDrop(event)">
                                            <div class="fileinput fileinput-new" data-provides="fileinput" title="结算人身份证反面">
                                                <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                    <div style="margin-top: 30%;color: #2a4d6c"><p style="color: #ff0000;">＊结算人身份证反面</p>
                                                        <p class="badge badge-danger">7</p>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-sm-3" ondrop="drop(event)" ondragover="allowDrop(event)">
                                            <div class="fileinput fileinput-new" data-provides="fileinput" title="手持身份证">
                                                <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                    <div style="margin-top: 30%;color: #2a4d6c"><p><span style="color: #ff0000;display: none" id="handIdcardPic_red">＊</span>手持身份证</p>
                                                        <p class="badge badge-success">22</p>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3" ondrop="drop(event)" ondragover="allowDrop(event)">
                                            <div class="fileinput fileinput-new" data-provides="fileinput" title="开户许可证">
                                                <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                    <div style="margin-top: 30%;color: #2a4d6c"><p>开户许可证</p>
                                                        <p class="badge badge-success">8</p></div>
                                                </div>
                                        ...
                                        <div class="col-sm-3" ondrop="drop(event)" ondragover="allowDrop(event)">
                                            <div class="fileinput fileinput-new" data-provides="fileinput" title="银行卡正面">
                                                <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                    <div style="margin-top: 30%;color: #2a4d6c"><p>银行卡正面</p> <p class="badge badge-success">9</p></div>
                                                </div>
                                        ...
                                        <div class="col-sm-3" ondrop="drop(event)" ondragover="allowDrop(event)">
                                            <div class="fileinput fileinput-new" data-provides="fileinput" title="银行卡反面">
                                                <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                    <div style="margin-top: 30%;color: #2a4d6c"><p>银行卡反面</p><p class="badge badge-success">10</p></div>
                                                </div>
                                        ...
                                        <div class="col-sm-3" ondrop="drop(event)" ondragover="allowDrop(event)">
                                            <div class="fileinput fileinput-new" data-provides="fileinput" title="商户协议照片">
                                                <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                    <div style="margin-top: 30%;color: #2a4d6c"><p style="color: #ff0000;">＊商户协议照片</p><p class="badge badge-danger">11</p></div>
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3" ondrop="drop(event)" ondragover="allowDrop(event)">
                                            <div class="fileinput fileinput-new" data-provides="fileinput" title="门头照片">
                                                <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                    <div style="margin-top: 30%;color: #2a4d6c"><p style="color: #ff0000;">＊门头照片</p><p class="badge badge-danger">12</p></div>
                                                </div>
                                        ...
                                        <div class="col-sm-3" ondrop="drop(event)" ondragover="allowDrop(event)">
                                            <div class="fileinput fileinput-new" data-provides="fileinput" title="经营场所-含收银台">
                                                <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                    <div style="margin-top: 30%;color: #2a4d6c"><p>经营场所-含收银台</p><p class="badge badge-success">13</p></div>
                                                </div>
                                        ...
                                        <div class="col-sm-3" ondrop="drop(event)" ondragover="allowDrop(event)">
                                            <div class="fileinput fileinput-new" data-provides="fileinput" title="租赁协议一(封面)">
                                                <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                    <div style="margin-top: 30%;color: #2a4d6c"><p>租赁协议一(封面)</p><p class="badge badge-success">14</p></div>
                                                </div>
                                        ...
                                        <div class="col-sm-3" ondrop="drop(event)" ondragover="allowDrop(event)">
                                            <div class="fileinput fileinput-new" data-provides="fileinput" title="租赁协议二(面积、有效期页)">
                                                <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                    <div style="margin-top: 30%;color: #2a4d6c"><p>租赁协议二(面积、有效期页)</p><p class="badge badge-success">15</p></div>
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3" ondrop="drop(event)" ondragover="allowDrop(event)">
                                            <div class="fileinput fileinput-new" data-provides="fileinput" title="租赁协议三(签章页)">
                                                <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                    <div style="margin-top: 30%;color: #2a4d6c"><p>租赁协议三(签章页)</p><p class="badge badge-success">16</p></div>
                                                </div>
                                        ...
                                        <div class="col-sm-3" ondrop="drop(event)" ondragover="allowDrop(event)">
                                            <div class="fileinput fileinput-new" data-provides="fileinput" title="其他资料照片1">
                                                <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                    <div style="margin-top: 30%;color: #2a4d6c"><p>其他资料照片1</p><p class="badge badge-success">17</p></div>
                                                </div>
                                        ...
                                        <div class="col-sm-3" ondrop="drop(event)" ondragover="allowDrop(event)">
                                            <div class="fileinput fileinput-new" data-provides="fileinput" title="其他资料照片2">
                                                <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                    <div style="margin-top: 30%;color: #2a4d6c"><p>其他资料照片2</p><p class="badge badge-success">18</p></div>
                                                </div>
                                        ...
                                        <div class="col-sm-3" ondrop="drop(event)" ondragover="allowDrop(event)">
                                            <div class="fileinput fileinput-new" data-provides="fileinput" title="其他资料照片3">
                                                <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                    <div style="margin-top: 30%;color: #2a4d6c"><p>其他资料照片3</p><p class="badge badge-success">19</p></div>
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3" ondrop="drop(event)" ondragover="allowDrop(event)">
                                            <div class="fileinput fileinput-new" data-provides="fileinput" title="其他资料照片4">
                                                <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                    <div style="margin-top: 30%;color: #2a4d6c"><p>其他资料照片4</p><p class="badge badge-success">20</p></div>
                                                </div>
                                        ...
                                        <div class="col-sm-3" ondrop="drop(event)" ondragover="allowDrop(event)">
                                            <div class="fileinput fileinput-new" data-provides="fileinput" title="其他资料照片5" >
                                                <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                    <div style="margin-top: 30%;color: #2a4d6c"><p>其他资料照片5</p><p class="badge badge-success">21</p></div>
                                                </div>
                                   ...
                                   %{-- <div class="col-sm-6 col-md-3" >
                                        <a href="#" class="thumbnail" >
                                            <img src="http://image.zhangxinxu.com/image/blog/zxx_90_0824.jpg"
                                                 alt="通用的占位符缩略图">
                                        </a>
                                    </div>--}%
            ...
            <form:actions>
                %{--<input type="button" value="test" onclick="autoSaveImg();">--}%
