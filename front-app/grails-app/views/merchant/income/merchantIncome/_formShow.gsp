...
<component:portlet>
    ...
    <portlet:body withForm="true">
        ...
        %{--设置隐藏域--}%
            ...
            <!--业务员编号-->
            <formCommon:hiddenField name="salesmanCode" id="salesmanCode" value="${merchantIncomeInstance?.salesmanCode}"/>
            <!--《费用信息隐藏设置》 -->
             <!--收取模式:1=预收，2=后收(默认) -->
            ...
            <formCommon:hiddenField name="rateInfomation" id="rateInfomation" value="${merchantIncomeInstance?.rateInfomation}"/>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group-sm">
                                    <label class="col-sm-5 control-label">
                                        %{--商户类型--}%
                                        <message:property domain="merchantIncome" property="merchantType"/><span class="required">*</span>:
                                    </label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group-sm">
                                    <label class="col-sm-5 control-label">
                                        %{--签购单名称--}%
                                        <message:property domain="merchantIncome" property="receiptsName"/><span class="required">*</span>:
                                    </label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group-sm">
                                    <label class="col-sm-5 control-label">
                                        %{--注册名称：--}%
                                        <message:property domain="merchantIncome" property="registName"/><span class="required">*</span>:
                                    </label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group-sm">
                                    <label class="col-sm-5 control-label">
                                        ...
                                        <message:property domain="merchantIncome" property="branchShopSet"/><span class="required">*</span>:
                        ...
                        <div id="subjectionDiv" class="hidden row">
                            <div class="col-md-4">
                                <div class="form-group-sm">
                                    <label class="col-sm-5 control-label">
                                        %{--隶属商户编号--}%
                                        <message:property domain="merchantIncome" property="subjectionMerchantCode"/><span class="required">*</span>:
                                    </label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group-sm">
                                    <label class="col-sm-5 control-label">
                                        %{--隶属商户名称--}%
                                        <message:property domain="merchantIncome" property="subjectionMerchantName"/><span class="required">*</span>:
                                    </label>
                    ...
                    %{--商户等级--}%
                        ...
                        <div class="row" style="margin-bottom: 0.5rem;">
                            <div class="col-md-10">
                                ...
                                <div class="form-group-sm">
                                    <label class="col-sm-2 control-label">
                                        <message:property domain="merchantIncome" property="registAddressProvince"/><span class="required">*</span>:
                                    </label>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group-sm">
                                    <label class="col-sm-5 control-label">
                                        %{--注册地址街道--}%
                                        <message:property domain="merchantIncome" property="registAddressStreet"/><span class="required">*</span>:
                                    </label>
                        ...
                        <div class="row" style="margin-bottom: 0.5rem;">
                            <div class="col-md-10">
                                ...
                                <div class="form-group-sm">
                                    <label class="col-sm-2 control-label">
                                        <message:property domain="merchantIncome" property="bindAddressProvince"/><span class="required">*</span>:
                                    </label>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group-sm">
                                    <label class="col-sm-5 control-label">
                                        %{--装机地址街道--}%
                                        <message:property domain="merchantIncome" property="bindAddressStreet"/><span class="required">*</span>:
                                    </label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group-sm">
                                    <label class="col-sm-5 control-label">
                                        %{--主营业务--}%
                                        <message:property domain="merchantIncome" property="mainManageBusiness"/><span class="required">*</span>:
                                    </label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group-sm">
                                    <label class="col-sm-5 control-label">
                                        %{--注册登记号--}%
                                        <message:property domain="merchantIncome" property="registCode"/><span class="required">*</span>:
                                    </label>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group-sm">
                                    <label class="col-sm-5 control-label">
                                        %{--业务员名称--}%
                                        <message:property domain="merchantIncome" property="salesmanName"/><span class="required">*</span>:
                                    </label>
                                    ...
                                    <div class="col-sm-7 ${hasErrors(bean: merchantIncomeInstance, field: 'salesmanName', ' takin-input-errors')}">
                                        <div class="input-group">
                                            ...
                                            <g:select style="margin-bottom: 0.5rem;" class="form-control select2" name="salesmanCode"
                                                      ...
                                                      valueMessagePrefix="merchantIncome.salesmanName"
                                                      noSelection="['': '请选择']"/>
                            ...
                            <div class="col-md-4">
                                <div class="form-group-sm">
                                    <label class="col-sm-5 control-label">
                                        %{--法人姓名--}%
                                        <message:property domain="merchantIncome" property="legalPersonName"/><span class="required">*</span>:
                                    </label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group-sm">
                                    <label class="col-sm-5 control-label">
                                        %{--法人证件号--}%
                                        <message:property domain="merchantIncome" property="legalPersonCode"/>:
                                    </label>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group-sm">
                                    <label class="col-sm-5 control-label">
                                        %{--联系人手机号：--}%
                                        <message:property domain="merchantIncome" property="linkmanMobileNo"/><span class="required">*</span>:
                                    </label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group-sm">
                                    <label class="col-sm-5 control-label">
                                        %{--结算人身份证号--}%
                                        <message:property domain="merchantIncome" property="settleManidNumber"/><span class="required">*</span>:
                                    </label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group-sm">
                                    <label class="col-sm-5 control-label">
                                        %{--行业大类--}%
                                        <message:property domain="merchantIncome" property="businessClassify"/><span class="required">*</span>:
                                    </label>
                        ...
                        <div id="bt1" class="hidden row">
                            <div class="col-md-4">
                                <div class="form-group-sm">
                                    <label class="col-sm-5 control-label">
                                        %{--所在银行--}%
                                        <message:property domain="merchantIncome" property="customerManagerBank"/><span class="required">*</span>:
                            ...
                            <div class="col-md-4">
                                <div class="form-group-sm">
                                    <label class="col-sm-5 control-label">
                                        %{--合作经理--}%
                                        <message:property domain="merchantIncome" property="customerManager"/><span class="required">*</span>:
                                    </label>
                        ...
                        <div id="bt2" class="hidden row">
                            <div class="col-md-4">
                                <div class="form-group-sm">
                                    <label class="col-sm-5 control-label">
                                        %{--银行合作标识--}%
                                        <message:property domain="merchantIncome" property="bankTeamworkSign"/><span class="required">*</span>:
                                    </label>
                                            ...
                                            <div class="row">
                                                <div class="col-md-1 col-md-offset-1">
                                                    <label class="control-label small">
                                                        ...
                                                        <message:property domain="merchantIncome" property="functionAcceptanceSettle"/><span class="required">*</span>:
                                                ...
                                                <div class="col-md-10 col-md-offset-1">
                                                    <div class="form-group-sm col-sm-6">
                                                        <label class="col-sm-4 control-label">
                                                            %{--即日付额(即日付手续费)--}%
                                                            <message:property domain="merchantIncome" property="intradayPayCounterFee"/><span
                                                                class="required">*</span>:
                                                        </label>
                                            ...
                                            <div id="sytDiv1" class="hidden row">
                                                <div class="col-md-10">
                                                    <div class="form-group-sm col-sm-6">
                                                        <label class="col-sm-5 control-label">
                                                            %{--随意通限额--}%
                                                            <message:property domain="merchantIncome" property="suiYiTongQuota"/><span
                                                                class="required">*</span>:
                                                        </label>
                                                    ...
                                                    <div class="form-group-sm col-sm-4">
                                                        <label class="col-sm-6 control-label">
                                                            %{--随意通手续费--}%
                                                            <message:property domain="merchantIncome" property="suiYiTongCountrFee"/><span
                                                                class="required">*</span>:
                                                        </label>
                                            ...
                                            <div id="posDiv" class="hidden row">
                                                <div class="col-md-10 col-md-offset-1">
                                                    ...
                                                    <div class="form-group-sm col-sm-4 margin-top-10">
                                                        <label class="col-sm-5 control-label">
                                                            %{--收取金额：--}%
                                                            <message:property domain="merchantIncome" property="maintainFeeOfPos"/><span
                                                                class="required">*</span>:
                                                        </label>
                                            ...
                                            <div id="whtDiv" class="hidden row">
                                                <div class="col-md-10 col-md-offset-1">
                                                    <div class="form-group-sm col-sm-4">
                                                        <label class="col-sm-5 control-label">
                                                            %{--收取金额：--}%
                                                            <message:property domain="merchantIncome" property="collectAmount"/><span
                                                                class="required">*</span>:
                                                        </label>
                                        ...
                                        %{--<portlet:body withForm="false">--}%
                                            ...
                                            %{--<div id="preDiv1" class="hidden row">--}%
                                                %{--<div class="col-md-2 col-md-offset-1">--}%
                                                    %{--<div class="form-group-sm">--}%
                                                        %{--<label class="control-label">--}%
                                                            %{--功能受理:0=关，1=一般刷卡，2=预授权，3=在线退货'--}%
                                                            %{--&nbsp;&nbsp;&nbsp;&nbsp;<message:property domain="merchantIncome" property="functionAcceptancePrepaidCa"/>--}%
                                            ...
                                            %{--<div id="preDiv2" class="hidden row">--}%
                                                ...
                                                %{--<div class="col-md-2 col-md-offset-1">--}%
                                                    %{--<div class="form-group-sm">--}%
                                                        %{--<label class="control-label">--}%
                                                            %{--<message:property domain="merchantIncome" property="gaoHuiTongMerchantCode"/>--}%
                                                            %{--<span class="required">*</span>:--}%
                                                        %{--</label>--}%
                                                    %{--</div>--}%
                                                %{--</div>--}%
                                            ...
                                            %{--<div id="bcmDiv1" class="hidden row">--}%
                                                %{--<div class="col-md-4">--}%
                                                    %{--<div class="form-group-sm">--}%
                                                        %{--<label class="col-sm-5 control-label">--}%
                                                            %{--<message:property domain="merchantIncome" property="rateVisa"/><span--}%
                                                                %{--class="required">*</span>:--}%
                                                        %{--</label>--}%
                                                ...
                                                %{--<div class="col-md-4">--}%
                                                    %{--<div class="form-group-sm">--}%
                                                        %{--<label class="col-sm-5 control-label">--}%
                                                            %{--<message:property domain="merchantIncome" property="rateMaster"/><span--}%
                                                                %{--class="required">*</span>:--}%
                                                        %{--</label>--}%
                                                ...
                                                %{--<div class="col-md-4">--}%
                                                    %{--<div class="form-group-sm">--}%
                                                        %{--<label class="col-sm-5 control-label">--}%
                                                            %{--<message:property domain="merchantIncome" property="rateAmericanExpress"/><span--}%
                                                                %{--class="required">*</span>:--}%
                                                        %{--</label>--}%
                                            ...
                                            %{--<div id="bcmDiv2" class="hidden row">--}%
                                                %{--<div class="col-md-4">--}%
                                                    %{--<div class="form-group-sm">--}%
                                                        %{--<label class="col-sm-5 control-label">--}%
                                                            %{--<message:property domain="merchantIncome" property="rateDiners"/><span--}%
                                                                %{--class="required">*</span>:--}%
                                                        %{--</label>--}%
                                                ...
                                                %{--<div class="col-md-4">--}%
                                                    %{--<div class="form-group-sm">--}%
                                                        %{--<label class="col-sm-5 control-label">--}%
                                                            %{--<message:property domain="merchantIncome" property="rateJCB"/><span--}%
                                                                %{--class="required">*</span>:--}%
                                                        %{--</label>--}%
                                                ...
                                                %{--<div class="col-md-4">--}%
                                                    %{--<div class="form-group-sm">--}%
                                                        %{--<label class="col-sm-5 control-label">--}%
                                                            %{--<message:property domain="merchantIncome" property="rateVISADCC"/><span--}%
                                                                %{--class="required">*</span>:--}%
                                                        %{--</label>--}%
                                            ...
                                            %{--<div id="bcmDiv3" class="hidden row">--}%
                                                %{--<div class="col-md-4">--}%
                                                    %{--<div class="form-group-sm">--}%
                                                        %{--<label class="col-sm-5 control-label">--}%
                                                            %{--<message:property domain="merchantIncome" property="rateMCDCC"/><span--}%
                                                                %{--class="required">*</span>:--}%
                                                        %{--</label>--}%
...
<content tag="takin-footer">
    ...
    <asset:javascript src="merchantIncome/merchantIncomeShow.js"/>
...
//        $("select",document.forms[0]).each(function(){
