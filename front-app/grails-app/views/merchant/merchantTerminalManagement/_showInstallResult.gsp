...
<div class="modal fade modal-dialog modal-lg" id="installResultModal" tabindex="-1" role="basic" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <g:if test="${code == '0'}">
                ...
                <div hidden="hidden">
                    <form action="getPdfReport" method="post" data-action="getPdfReport" id="getInstallPdfReport" target="_blank">
                        <form:body>
                            ...
                            <formCommon:hiddenField name="postyp" id="postyp" value="1"/>
                            <formCommon:hiddenField name="sign" id="sign88" value="${merchantTerminalManagementInstance?.sign}"/>
                            <formCommon:hiddenField id="simModList88" name="simModList" value="${merchantTerminalManagementInstance?.simModList}"/>
                        ...
                        <g:if test="${code==0}">
                            <div class="col-md-6 text-right">
                                %{--<button type="button" class="btn blue" data-dismiss="modal">确定</button>--}%
                                 <button type="button" class="btn btn-ok" onclick="merchantTerminalManagementSearchForm(this)">确定</button>
                            </div>
                            <div class="col-md-6 text-left">
                                %{--<button type="button" controller="merchantTerminalManagement" action="balancePay" class="btn blue">打印</button>--}%
                                <button type="button" class="btn btn-print" onclick="printInstallOrder()">打印</button>
                            </div>
                        </g:if>
                        <g:if test="${code!=0}">
...
<script type="text/javascript">
    function merchantTerminalManagementSearchForm(node){
        $('#merchantTerminalManagementSearchForm').submit();
    }

    function printInstallOrder(){
        $("#getInstallPdfReport").submit();
    }
</script>