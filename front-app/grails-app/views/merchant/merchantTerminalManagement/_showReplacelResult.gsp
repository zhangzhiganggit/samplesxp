...
<div class="modal fade modal-dialog modal-lg" id="replaceResultModal" tabindex="-1" role="basic" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <g:if test="${code == '0'}">
                ...
                <div hidden="hidden">
                    <form action="getPdfReport" method="post" data-action="getPdfReport" id="getReplacePdfReport" target="_blank">
                        <form:body>
                            ...
                            <formCommon:hiddenField name="postyp" id="postyp" value="2"/>
                            <formCommon:hiddenField name="attSnSimOld" id="attSnSimOld" value="${merchantTerminalManagementInstance?.attSnSimOld}"/>
                            <formCommon:hiddenField name="attSnKeyOld" id="attSnKeyOld" value="${merchantTerminalManagementInstance?.attSnKeyOld}"/>
                            <formCommon:hiddenField name="trmSnOld" id="trmSnOld" value="${merchantTerminalManagementInstance?.trmSnOld}"/>
                            <formCommon:hiddenField name="trmNoOld" id="trmNoOld" value="${merchantTerminalManagementInstance?.trmNoOld}"/>
                            <formCommon:hiddenField name="modNmOld" id="modNmOld" value="${merchantTerminalManagementInstance?.modNmOld}"/>
                    ...
                    <div class="row">
                        <g:if test="${code==0}">
                            ...
                            <div class="col-md-6 text-left">
                                ...
                                <button type="button" class="btn btn-print" onclick="printReplaceOrder()">打印</button>
                            </div>
                        </g:if>
                        <g:if test="${code!=0}">
...
<script type="text/javascript">
    ...
    function printReplaceOrder(){
        $("#getReplacePdfReport").submit();
    }
</script>