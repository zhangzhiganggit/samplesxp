<div class="col-xs-12 col-md-4 col-sm-4">
    <div class="form-group">
        ...
        <div class="col-md-8">
            <g:select class="form-control" name="q_${property}" from="${from}" value="${params ? params['q_' + property] : '' }" valueMessagePrefix="${domain}.${property}" noSelection="${noSelection?noSelection:['':'']}" />
        </div>
    </div>
</div>
