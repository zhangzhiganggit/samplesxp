                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <label class="control-label col-md-4"><i class="fa fa-question-circle show-pop" data-popover-message="<g:message
                                code="assistBillQuery.assistLevel.show-pop.label"></g:message>"></i> <span class="required">*</span><message:property domain="assistBillQuery"
                        ...
                        <div class="col-md-8">
                            <p class="form-control-static" readonly="true">${assistBillQueryInstance?.assistLevel}</p>
                        </div>
                    </div>
                </div>
        ...
        <form:form>
            <form:body>
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="col-md-2 control-label"><span class="required">*</span>${message(code: "assistBillQuery.treatmentOpinion.label")}<g:message code="dashBoard.system.colon"></g:message>

                            </label>

                            <div class="col-md-10  ${hasErrors(bean: assistBillQueryInstance, field: treatmentOpinion, ' takin-input-errors')}">
                                <textarea class="form-control" domain="assistBillQuery"
                                          domainInstance="${assistBillQueryInstance}" name="treatmentOpinion" required="required"
                                          id="treatmentOpinion" property="treatmentOpinion" rows="2"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="col-md-2 control-label">
                                ${message(code: 'assistBillQuery.dataUploadAndDescription.label')}<g:message code="dashBoard.system.colon"></g:message>

                            </label>

                            <div class="col-md-10">
                                <span>如果没有签购单，可提供持卡人不拒付声明、持卡人身份证正反面照片、持卡人银行卡正反面照片、持卡人手持身份证照片或监控录像等交易有力证据</span>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <g:link class="btn btn-upload" data-toggle="modal" data-target="#pictureUpload"
                                        controller="assistBillQuery"
...
<component:portlet>
    ...
    <portlet:body>
        <div class="table-scrollable text-nowrap bootstro" data-bootstro-title="" data-bootstro-content="${message(code:"assistBillQuery.logHistory.pageGuide.label")}<div class='input-view'><input id='assistBillQuery.handleRisk.index' type='checkbox' class='popCheck'  onclick='neverShow();'/>下次不要显示<div>" data-bootstro-width="400px" data-bootstro-placement="top" data-bootstro-step="0">
            <table class="table table-striped table-bordered table-hover dataTable no-footer">
                <thead>
                <tr>
...
<asset:javascript src="global/plugins/bootstro/js/bootstro.js"/>
    <g:javascript>
        $(function(){
         ...
         checkIsShowStro("assistBillQuery.handleRisk.index");

        });
        function handleSubmit() {
            $(".btn-ok").attr("disabled", true);
            if ($('#treatmentOpinion').val().trim() == '') {
                bootbox.alert("处理意见不能为空！");
                $(".btn-ok").attr("disabled", false);
                return
            }
            if(getLen($('#treatmentOpinion').val()) > 200 ){
                bootbox.alert('处理意见不能超过200字符')
                $(".btn-ok").attr("disabled", false);
                return
            }
            ...
            var treatmentOpinion = $("#treatmentOpinion").val();
            $.ajax({
