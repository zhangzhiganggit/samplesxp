    <div id="typediv21" style="display: block;">
                        ...
                        <tr>
                            <div class="row">
                                <a class="dashboard-stat dashboard-stat-v2 blue" href="javascript:void(0)">
                                    ...
                                    <div class="details">
                                        <div class="number">跌幅金额:
                                            <span data-counter="counterup" type="number"data-value="1349">
    ...
    <div id="typediv11" style="display: none;">
        <div class="portlet-body form">
            <div class="table-scrollable" style="height: auto;overflow-y :auto">
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <domainSearchResult:header domain="dashBoard" property="decreaseRanks"/>
                    </tr>
                    </thead>
                    <tbody><g:each var="dashBoardInstance" status="i"
                        ...
                        <tr>
                            ...
                            <domainSearchResult:rowData type="text" domain="dashBoard" property="signName"
                                                        domainInstance="${dashBoardInstance}" textAlign="left"/>
                            <td align="right" style="color:green;"> <g:formatNumber number="${dashBoardInstance.riseFallRatio}" type="number" minFractionDigits="2" maxFractionDigits="2"/></td>
