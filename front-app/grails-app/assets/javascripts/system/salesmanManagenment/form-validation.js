...
var FormValidation = function() {
    var e = function() {
        var addForm = $("#salesmanManagementForm");
        addForm.validate({
            errorElement: "span",
            ...
            messages: {
                ...
                "systemUserInstance.phone" : {required: "手机号码-不能为空.",digits:"手机号只能输入数字.",minlength:"请输入11位手机号.",maxlength:"请输入11位手机号."},
            ...
            rules: {
                ...
                "systemUserInstance.phone": {onlyNum : true ,required: true,digits:true,minlength: 11,maxlength: 11,phoneOnly:true},
