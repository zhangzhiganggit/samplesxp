...
var FormValidation = function() {
    var e = function() {
        var addForm = $("#scaffold-save-merchantIncome");
        addForm.validate({
            errorElement: "span",
            ...
            messages: {
                ...
                toPrivateSettleAccountNo: {byteRangeLength:"请输入5-30个字符.",number:"请输入合法的数字."},
                toPrivateAccountName: {byteMaxLength:"最多输入60个字符."},
            ...
            rules: {
                ...
                toPrivateAccountName: {byteMaxLength: 60},
