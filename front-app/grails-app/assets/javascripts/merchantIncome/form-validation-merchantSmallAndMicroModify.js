/**
 * Created by zhoun on 2017/05/03.
 * 小微修改信息Form表单JS校验
 */
var FormValidation = function() {
    var e = function() {
        var addForm = $("#sscaffold-update-merchantSmallAndMicroModify");
        if(addForm.children().length==0){
            addForm = $("#scaffold-update-merchantSmallAndMicroModify");
        }
        addForm.validate({
            errorElement: "span",
            ...
            messages: {
                ...
                salesmanCode:{required: "业务员名称-不能为空."},
                  receiptsName: {required: "商户名称-不能为空.",byteMaxLength:"最多输入80个字符."},
                ...
                linkmanMobileNo: {required: "联系人手机号-不能为空.",digits:"只能输入整数.",minlength:"请输入11位手机号.",maxlength:"请输入11位手机号."},
                ...
                toPrivateCnapsCode: {required: "开户行信息-不能为空."},
            ...
            rules: {
                ...
                //receiptsName: {required: true, byteRangeLength: [12, 40]},
                 receiptsName: {required: true, byteMaxLength: 80},
                ...
                legalPersonCode:{ required: true,idcard:true},
                ...
                toPrivateCnapsCode: {required: true},
