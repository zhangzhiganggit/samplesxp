...
$(document).ready(function(){
    ...
    (function( bootstro, $, undefined ) {
        ...
        var defaults = {
            ...
            finishButtonText : '<i class="icon-ok"></i> 我知道了，我要返回当前页',
        ...
        get_popup = function(i)
        {
            ...
            p.template = '<div class="popover popover-vb" style="' + style + '"><div class="arrow"></div><div class="popover-inner"><h3 class="popover-title"></h3><div class="popover-content popover-md"><p></p></div></div>' +
             '</div>';
